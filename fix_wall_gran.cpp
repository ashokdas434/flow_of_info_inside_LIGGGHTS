...
fprintf(screen,"Fix_wall_gran is being used \n");
}
...
{
printf("=================JCPRINT:FixWallGran::post_create is being called  ======\n");
    if(strncmp(style,"wall/gran",9) != 0)
    {
...
{
printf("=================JCPRINT:FixWallGran::pre_delete is being called  ======\n");
...
{
printf("=================JCPRINT:FixWallGran::setmask is being called  ======\n");
    int mask = 0;
    mask |= PRE_NEIGHBOR;
    mask |= PRE_FORCE;
    mask |= POST_FORCE;
...
{
printf("=================JCPRINT:FixWallGran::min_type is being called  ======\n");
...
{
printf("=================JCPRINT:FixWallGran::max_type is being called  ======\n");
    return atom_type_wall_;
}
...
{ 
printf("=================JCPRINT:FixWallGran::primitiveWall is being called  ======\n");
...
{
printf("=================JCPRINT:FixWallGran::init is being called  ======\n");
    dt_ = update->dt;
...
{
printf("=================JCPRINT:FixWallGran::createMulticontactData is being called  ======\n");
...
{
printf("=================JCPRINT:FixWallGran::setup is being called  ======\n");
...
{
printf("=================JCPRINT:FixWallGran::pre_neighbor is being called  ======\n");
    rebuildPrimitiveNeighlist_ = (primitiveWall_ != 0);
}

void FixWallGran::pre_force(int vflag)
{
printf("=================JCPRINT:FixWallGran::pre_force is being called  ======\n");
...
{
printf("=================JCPRINT:FixWallGran::post_force is being called  ======\n");
    computeflag_ = 1;
    shearupdate_ = 1;
...
{
printf("=================JCPRINT:FixWallGran::post_force_pgl is being called  ======\n");
    computeflag_ = 0;
    shearupdate_ = 0;
    addflag_ = 1;
...
{
printf("=================JCPRINT:FixWallGran::post_force_wall is being called  ======\n");
...
{
printf("=================JCPRINT:FixWallGran::post_force_respa is being called  ======\n");
...
{
printf("=================JCPRINT:FixWallGran::post_force_mesh is being called  ======\n");
...
{
printf("=================JCPRINT:FixWallGran::post_force_primitive is being called  ======\n");
  int *mask = atom->mask;
...
{
    printf("=================JCPRINT:FixWallGran::compute_force is being called  ======\n");
}
...
{
    printf("=================JCPRINT:FixWallGran::is_moving is being called  ======\n");
    if(is_mesh_wall())
    {
        for(int i = 0; i < n_FixMesh_; i++) {
...
{
printf("=================JCPRINT:FixWallGran::n_contacts_local is being called  ======\n");
...
{
printf("=================JCPRINT:FixWallGran::n_contacts_all is being called  ======\n");
...
{
printf("=================JCPRINT:FixWallGran::register_compute_wall_local is being called  ======\n");
   if(cwl_ != NULL)
...
{
printf("=================JCPRINT:FixWallGran::unregister_compute_wall_local is being called  ======\n");
   if(cwl_ != ptr)
...
{
printf("=================JCPRINT:FixWallGran::init_heattransfer is being called  ======\n");
    fppa_T = NULL;
    fppa_hf = NULL;
    fppa_htcw = NULL;
    deltan_ratio = NULL;
...
{
printf("=================JCPRINT:FixWallGran::wall_temperature_unique is being called  ======\n");
    has_temp = false;
    temp_unique = true;
...
{
printf("=================JCPRINT:FixWallGran::addHeatFlux is being called  ======\n");
