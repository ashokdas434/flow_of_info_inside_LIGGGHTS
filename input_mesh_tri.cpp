...
exclusion_list_(0)
{
fprintf(screen,"input_mesh_tri is being used \n");
}
...
void InputMeshTri::meshtrifile(const char *filename, class TriMesh *mesh,bool verbose,
                               ...
                               class Region *region)
{
printf("================= JCPRINT:InputMeshTri::meshtrifile is being called ======\n");    
  verbose_ = verbose;
...
{
printf("================= JCPRINT:InputMeshTri::meshtrifile_vtk is being called ======\n");    
  int n,m;
...
{
printf("================= JCPRINT:InputMeshTri::meshtrifile_stl is being called ======\n");    
  int n,m;
  int iVertex = 0;
  double vertices[3][3];
...
{
printf("================= JCPRINT:InputMeshTri::meshtrifile_stl_binary is being called ======\n");    
...
{
printf("================= JCPRINT:InputMeshTri::addTriangle is being called ======\n");    
