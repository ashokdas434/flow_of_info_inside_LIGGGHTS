...
fprintf(screen,"timer is being used \n");
}
...
void Timer::init()
{
printf("================= JCPRINT: Timer::init  is being called ======\n");
...
void Timer::stamp()
{
printf("================= JCPRINT: Timer::stamp1  is being called ======\n");
...
{
printf("================= JCPRINT: Timer::stamp2  is being called ======\n");
  // uncomment if want synchronized timing
  // MPI_Barrier(world);
...
{
printf("================= JCPRINT: Timer::barrier_start  is being called ======\n");
  MPI_Barrier(world);
...
{
printf("================= JCPRINT: Timer::barrier_stop  is being called ======\n");
  MPI_Barrier(world);
  double current_time = MPI_Wtime();
...
{
printf("================= JCPRINT: Timer::elapsed  is being called ======\n");
  double current_time = MPI_Wtime();
