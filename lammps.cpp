...
fprintf(screen,"lammps is being used \n");
}
...
void LAMMPS::create()
{
printf("================= JCPRINT:LAMMPS::create is being called ======\n");
...
{
printf("================= JCPRINT:LAMMPS::post_create is being called ======\n");
...
void LAMMPS::init()
{
printf("================= JCPRINT:LAMMPS::init is being called ======\n");
...
void LAMMPS::destroy()
{
printf("================= JCPRINT:LAMMPS::destroy is being called ======\n");
  delete update;
  delete neighbor;
  delete comm;
  delete force;
...
void LAMMPS::help()
{
printf("================= JCPRINT:LAMMPS::help is being called ======\n");
  fprintf(screen,
...
{
printf("================= JCPRINT:LAMMPS::print_style is being called ======\n");
