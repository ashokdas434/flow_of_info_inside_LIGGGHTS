...
fprintf(screen,"force is being used \n");
}
...
void Force::init()
{
printf("================= JCPRINT:Force::init is being called ======\n");
  registry.init();
...
{
printf("================= JCPRINT:Force::create_pair is being called ======\n");
  delete [] pair_style;
  if (pair) delete pair;
...
{
printf("================= JCPRINT:Force::create_pair_from_restart is being called ======\n");
  delete [] pair_style;
  if (pair) delete pair;
...
{
printf("================= JCPRINT:Force::new_pair is being called ======\n");
...
{
printf("================= JCPRINT:Force::new_pair_from_restart is being called ======\n");
  if (suffix && lmp->suffix_enable) {
    sflag = 1;
    char estyle[256];
    sprintf(estyle,"%s/%s",style,suffix);
...
{
printf("================= JCPRINT:Force::pair_match is being called ======\n");
  int iwhich,count;
...
{
printf("================= JCPRINT:Force::create_bond is being called ======\n");
  delete [] bond_style;
  if (bond) delete bond;
...
{
printf("================= JCPRINT:Force::new_bond is being called ======\n");
  if (suffix && lmp->suffix_enable) {
    sflag = 1;
    char estyle[256];
    sprintf(estyle,"%s/%s",style,suffix);
...
{
printf("================= JCPRINT:Force::bond_match is being called ======\n");
...
{
printf("================= JCPRINT:Force::create_angle is being called ======\n");
  delete [] angle_style;
  if (angle) delete angle;
...
{
printf("================= JCPRINT:Force::new_angle is being called ======\n");
  if (suffix && lmp->suffix_enable) {
    sflag = 1;
    char estyle[256];
    sprintf(estyle,"%s/%s",style,suffix);
...
{
printf("================= JCPRINT:Force::create_dihedral is being called ======\n");
  delete [] dihedral_style;
  if (dihedral) delete dihedral;
...
{
printf("================= JCPRINT:Force::new_dihedral is being called ======\n");
  if (suffix && lmp->suffix_enable) {
    sflag = 1;
    char estyle[256];
    sprintf(estyle,"%s/%s",style,suffix);
...
{
printf("================= JCPRINT:Force::create_improper is being called ======\n");
  delete [] improper_style;
  if (improper) delete improper;
...
{
printf("================= JCPRINT:Force::new_improper is being called ======\n");
  if (suffix && lmp->suffix_enable) {
    sflag = 1;
    char estyle[256];
    sprintf(estyle,"%s/%s",style,suffix);
...
{
printf("================= JCPRINT:Force::create_kspace is being called ======\n");
  delete [] kspace_style;
  if (kspace) delete kspace;
...
{
printf("================= JCPRINT:Force::new_kspace is being called ======\n");
  if (suffix && lmp->suffix_enable) {
    sflag = 1;
    char estyle[256];
    sprintf(estyle,"%s/%s",arg[0],suffix);
...
{
printf("================= JCPRINT:Force::kspace_match is being called ======\n");
...
{
printf("================= JCPRINT:Force::set_special is being called ======\n");
...
{
printf("================= JCPRINT:Force::bounds is being called ======\n");
  char *ptr = strchr(str,'*');
...
{
printf("================= JCPRINT:Force::numeric is being called ======\n");
...
{
printf("================= JCPRINT:Force::inumeric is being called ======\n");
    const unsigned int n = strlen(str);
    char *istr;
    istr = new char[n+1];
    for (unsigned int i = 0; i < n; i++)
...
{
printf("================= JCPRINT:Force::memory_usage is being called ======\n");
  bigint bytes = 0;
