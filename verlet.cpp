...
fprintf(screen,"verlet being used \n");
}
...
void Verlet::init()
{
printf("================= JCPRINT: Verlet::init  is being called ======\n");
  Integrate::init();
...
void Verlet::setup()
{
printf("================= JCPRINT: Verlet::setup  is being called ======\n");
  time_t curtime;
  time(&curtime);
...
{
printf("================= JCPRINT: Verlet::setup_minimal  is being called ======\n");
  update->setupflag = 1;
...
{
printf("================= JCPRINT: Verlet::run  is being called ======\n");
  bigint ntimestep;
  int nflag,sortflag;
...
void Verlet::cleanup()
{
printf("================= JCPRINT: Verlet::cleanup  is being called ======\n");
  modify->post_run();
  domain->box_too_small_check();
  update->update_time();
}
...
{
printf("================= JCPRINT: Verlet::force_clear  is being called ======\n");
  int i;
