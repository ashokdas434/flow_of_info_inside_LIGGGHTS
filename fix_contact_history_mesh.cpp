...
fprintf(screen,"Fix_contact_history_mesh is being used \n");
}
...
{
printf("================= JCPRINT:FixContactHistoryMesh::setmask is being called ======\n");
  int mask = 0;
  mask |= PRE_FORCE;
  mask |= MIN_PRE_FORCE;
  mask |= PRE_NEIGHBOR;
...
{
printf("================= JCPRINT:FixContactHistoryMesh::init is being called ======\n");
...
{
printf("================= JCPRINT:FixContactHistoryMesh::allocate_pages is being called ======\n");
...
{
printf("================= JCPRINT:FixContactHistoryMesh::setup_pre_neighbor is being called ======\n");
}
...
{
printf("================= JCPRINT:FixContactHistoryMesh::setup_pre_exchange is being called ======\n");
    pre_exchange();
}
/* ---------------------------------------------------------------------- */
...
{
printf("================= JCPRINT:FixContactHistoryMesh::min_setup_pre_exchange is being called ======\n");
  pre_exchange();
}
...
{
printf("================= JCPRINT:FixContactHistoryMesh::pre_exchange is being called ======\n");
...
{
printf("================= JCPRINT:FixContactHistoryMesh::setup_pre_force is being called ======\n");
   pre_neighbor();
   pre_force(0);
}
...
{
printf("================= JCPRINT:FixContactHistoryMesh::pre_neighbor is being called ======\n");
    build_neighlist_ = true;
...
{
printf("================= JCPRINT:FixContactHistoryMesh::pre_force is being called ======\n");
    if(!build_neighlist_)
        return;
...
{
printf("================= JCPRINT:FixContactHistoryMesh::sort_contacts is being called ======\n");
    const int nlocal = atom->nlocal;
...
{
printf("================= JCPRINT:FixContactHistoryMesh::markAllContacts is being called ======\n");
    const int nlocal = atom->nlocal;
...
{
printf("================= JCPRINT:FixContactHistoryMesh::cleanUpContacts is being called ======\n");
...
{
printf("================= JCPRINT:FixContactHistoryMesh::cleanUpContacts1 is being called ======\n"); 
...
{
printf("================= JCPRINT:FixContactHistoryMesh::cleanUpContactJumps is being called ======\n"); 
    const int nlocal = atom->nlocal;
...
{
printf("================= JCPRINT:FixContactHistoryMesh::reset_history is being called ======\n"); 
    const int nlocal = atom->nlocal;
...
{
printf("================= JCPRINT:FixContactHistoryMesh::min_setup_pre_force is being called ======\n"); 
...
{
printf("================= JCPRINT:FixContactHistoryMesh::min_pre_force is being called ======\n"); 
  pre_force(0);
}
...
{
printf("================= JCPRINT:FixContactHistoryMesh::grow_arrays is being called ======\n"); 
...
{
printf("================= JCPRINT:FixContactHistoryMesh::copy_arrays is being called ======\n"); 
...
{
printf("================= JCPRINT:FixContactHistoryMesh::unpack_exchange is being called ======\n"); 
...
{
printf("================= JCPRINT:FixContactHistoryMesh::unpack_restart is being called ======\n"); 
...
{
printf("================= JCPRINT:FixContactHistoryMesh::write_restart is being called ======\n"); 
...
{
printf("================= JCPRINT:FixContactHistoryMesh::memory_usage is being called ======\n"); 
  int nmax = atom->nmax;
...
{
printf("================= JCPRINT:FixContactHistoryMesh::get_contact is being called ======\n"); 
    int count = -1;
    int offset = 0;
