...
fprintf(screen,"output is being used \n");
}
...
void Output::init()
{
printf("================= JCPRINT:Output::init is being called ======\n");
  thermo->init();
  if (var_thermo) {
...
{
printf("================= JCPRINT:Output::setup is being called ======\n");
...
{
printf("================= JCPRINT:Output::write is being called ======\n");
...
{
printf("================= JCPRINT:Output::write_dump is being called ======\n");
  for (int idump = 0; idump < ndump; idump++) {
    dump[idump]->write();
    last_dump[idump] = ntimestep;
  }
...
{
printf("================= JCPRINT:Output::write_restart is being called ======\n");
  if (restart_flag_single) {
    char *file = new char[strlen(restart1) + 16];
    char *ptr = strchr(restart1,'*');
    *ptr = '\0';
...
{
printf("================= JCPRINT:Output::reset_timestep is being called ======\n");
...
{
printf("================= JCPRINT:Output::add_dump is being called ======\n");
...
{
printf("================= JCPRINT:Output::modify_dump is being called ======\n");
...
{
printf("================= JCPRINT:Output::delete_dump is being called ======\n");
...
{
printf("================= JCPRINT:Output::set_thermo is being called ======\n");
...
{
printf("================= JCPRINT:Output::create_thermo is being called ======\n");
...
{
printf("================= JCPRINT:Output::create_restart is being called ======\n");
...
{
printf("================= JCPRINT:Output::memory_usage is being called ======\n");
  bigint bytes = 0;
...
{
printf("================= JCPRINT:Output::restart_requested is being called ======\n");
...
{
printf("================= JCPRINT:Output::request_restart is being called ======\n");
    if (restart_flag)
    {
        next_restart = ntimestep;
        if (restart_every_single)
