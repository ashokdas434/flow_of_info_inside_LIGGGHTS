...
NeighRequest::NeighRequest(LAMMPS *lmp) : Pointers(lmp)
{
  ...
  ijskip = NULL;
  otherlist = -1;
fprintf(screen,"neigh_request is being used \n");
}
...
{
printf("====== JCPRINTS: NeighRequest::archive is being called\n");
  half_original = half;
...
{
printf("====== JCPRINTS: NeighRequest::identical is being called\n");
  int same = 1;
...
{
printf("====== JCPRINTS: NeighRequest::same_kind is being called\n");
  int same = 1;
...
{
printf("====== JCPRINTS: NeighRequest:: same_skip is being called\n");
  int i,j;
...
{
printf("====== JCPRINTS: NeighRequest:: copy_request is being called\n");
  half = 0;
