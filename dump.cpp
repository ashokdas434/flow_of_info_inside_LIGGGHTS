...
fprintf(screen,"dump is being used \n");
}
...
void Dump::init()
{
printf("====== JCPRINTS: Dump::init  is being called\n");
    init_style();
...
int Dump::count()
{
printf("====== JCPRINTS: Dump::count  is being called\n");
...
void Dump::write()
{
printf("====== JCPRINTS: Dump:: write  is being called\n");
...
void Dump::openfile()
{
printf("====== JCPRINTS: Dump::openfile  is being called\n");
...
{
printf("====== JCPRINTS: Dump::modify_params  is being called\n");
...
{
printf("====== JCPRINTS: Dump::memory_usage  is being called\n");
  bigint bytes = 0;
