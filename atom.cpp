...
fprintf(screen,"atom is being used \n");
}
...
{
printf("=================JCPRINT: Atom::settings is being called  ======\n");
...
{
printf("=================JCPRINT: Atom::create_avec is being called  ======\n");
  delete [] atom_style;
  if (avec) delete avec;
...
{
printf("=================JCPRINT: Atom:: new_avec is being called  ======\n");
...
void Atom::init()
{
printf("=================JCPRINT: Atom::init is being called  ======\n");
...
void Atom::setup()
{
printf("=================JCPRINT: Atom::setup is being called  ======\n");
...
{
printf("=================JCPRINT: Atom::style_match is being called  ======\n");
...
{
printf("=================JCPRINT: Atom::modify_params is being called  ======\n");
...
{
printf("=================JCPRINT: Atom::tag_extend is being called  ======\n");
...
{
printf("=================JCPRINT: Atom::tag_consecutive is being called  ======\n");
...
int Atom::tag_max()
{
printf("=================JCPRINT: Atom::tag_max is being called  ======\n");
  int idmax = 0;
...
{
printf("=================JCPRINT: Atom::count_words is being called  ======\n");
  int n = strlen(line) + 1;
  char *copy;
...
{
printf("=================JCPRINT: Atom::data_atoms is being called  ======\n");
  tagint imagedata;
...
{
printf("=================JCPRINT: Atom::data_vels is being called  ======\n");
  int j,m,tagdata;
  char *next;
...
{
printf("=================JCPRINT: Atom::data_bonus is being called  ======\n");
  int j,m,tagdata;
  char *next;
...
{
printf("=================JCPRINT: Atom::data_bodies is being called  ======\n");
...
{
printf("=================JCPRINT: Atom::data_bounds is being called  ======\n");
...
{
printf("=================JCPRINT: Atom::data_angles is being called  ======\n");
...
{
printf("=================JCPRINT: Atom::data_dihedral is being called  ======\n");
...
{
printf("=================JCPRINT: Atom::data_impropers is being called  ======\n");
  int m,tmp,itype,atom1,atom2,atom3,atom4;
  char *next;
  int newton_bond = force->newton_bond;
...
{
printf("=================JCPRINT: Atom::allocate_type_arrays is being called  ======\n");
  if (avec->mass_type) {
...
{
printf("=================JCPRINT: Atom::set_mass is being called  ======\n");
...
{
printf("=================JCPRINT: Atom::check_mass is being called  ======\n");
  if (mass == NULL) return;
  for (int itype = 1; itype <= ntypes; itype++)
...
{
printf("=================JCPRINT: Atom::radius_consistency is being called  ======\n");
  double value = -1.0;
  int flag = 0;
  for (int i = 0; i < nlocal; i++) {
...
{
printf("=================JCPRINT: Atom::shape_consistency is being called  ======\n");
...
{
printf("=================JCPRINT: Atom::first_reorder is being called  ======\n");
...
void Atom::sort()
{
printf("=================JCPRINT: Atom::sort is being called  ======\n");
...
{
printf("=================JCPRINT: Atom::setup_sort_bins is being called  ======\n");
  // binsize:
...
{
printf("=================JCPRINT: Atom::add_callback is being called  ======\n");
  int ifix;
...
{
printf("=================JCPRINT: Atom::delete_callback is being called  ======\n");
  int ifix;
  for (ifix = 0; ifix < modify->nfix; ifix++)
...
{
printf("=================JCPRINT: Atom::update_callback is being called  ======\n");
...
{
printf("=================JCPRINT: Atom::has_callback is being called  ======\n");
  int ifix;
  for (ifix = 0; ifix < modify->nfix; ifix++)
    if (strcmp(id,modify->fix[ifix]->id) == 0) break;
...
{
printf("=================JCPRINT: Atom::find_custom is being called  ======\n");
  for (int i = 0; i < nivector; i++)
...
{
printf("=================JCPRINT: Atom::add_custom is being called  ======\n");
  int index;
...
{
printf("=================JCPRINT: Atom::remove_custom is being called  ======\n");
  if (flag == 0) {
...
{
printf("=================JCPRINT: Atom::extract is being called  ======\n");
...
{
printf("=================JCPRINT: Atom::memory_usage is being called  ======\n");
...
{
printf("=================JCPRINT: Atom::memcheck is being called  ======\n");
