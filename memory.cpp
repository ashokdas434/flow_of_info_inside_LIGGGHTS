...
{
printf("================= JCPRINT:*Memory::smalloc is being called ======\n");    
...
{
printf("================= JCPRINT: *Memory::srealloc is being called ======\n");    
  if (nbytes == 0) {
    destroy(ptr);
    return NULL;
  }
...
{
printf("================= JCPRINT: Memory::sfree is being called ======\n");    
  if (ptr == NULL) return;
  free(ptr);
}
...
{
printf("================= JCPRINT: Memory::fail is being called ======\n");    
  char str[512];
