...
fprintf(screen,"Fix_mesh_surface is being used \n");
}
...
{
printf("================= JCPRINT:FixMeshSurface::post_create is being called ======\n");    
    FixMesh::post_create();
...
{
printf("================= JCPRINT:FixMeshSurface::post_create_pre_restart is being called ======\n");    
    std::vector<std::string>::iterator it;
    for(it = mesh_module_order.begin(); it != mesh_module_order.end(); it++)
...
{
printf("================= JCPRINT:FixMeshSurface::init is being called ======\n");    
    FixMesh::init();
...
{
printf("================= JCPRINT:FixMeshSurface::setup is being called ======\n");    
    FixMesh::setup(vflag);
...
{
printf("================= JCPRINT:FixMeshSurface::pre_delete is being called ======\n");    
...
{
printf("================= JCPRINT:FixMeshSurface::setmask is being called ======\n");    
...
{
printf("================= JCPRINT:FixMeshSurface::setup_pre_force is being called ======\n");    
...
{
printf("================= JCPRINT:FixMeshSurface::pre_force is being called ======\n");    
...
{
printf("================= JCPRINT:FixMeshSurface::initial_integrate is being called ======\n");    
    std::vector<std::string>::iterator it;
    for(it = mesh_module_order.begin(); it != mesh_module_order.end(); it++)
...
{
printf("================= JCPRINT:FixMeshSurface::final_integrate is being called ======\n");    
...
{
printf("================= JCPRINT:FixMeshSurface::end_of_step is being called ======\n");    
    std::vector<std::string>::iterator it;
    for(it = mesh_module_order.begin(); it != mesh_module_order.end(); it++)
...
{
printf("================= JCPRINT:FixMeshSurface::compute_vector is being called ======\n");    
    std::vector<std::string>::iterator it;
    for(it = mesh_module_order.begin(); it != mesh_module_order.end(); it++)
    {
...
{
printf("================= JCPRINT:FixMeshSurface::createWallNeighList is being called ======\n");    
...
{
printf("================= JCPRINT:FixMeshSurface::deleteWallNeighList is being called ======\n");    
...
{
printf("================= JCPRINT:FixMeshSurface::createOtherNeighList is being called ======\n");    
...
{
printf("================= JCPRINT:FixMeshSurface::deleteOtherNeighList is being called ======\n");    
    char *neighlist_name = new char[strlen(id)+1+20+strlen(nId)+1];
    sprintf(neighlist_name,"neighlist_%s_%s",nId,id);
...
{
printf("================= JCPRINT:FixMeshSurface::deleteAllOtherNeighList is being called ======\n");    
...
{
printf("================= JCPRINT:FixMeshSurface::createContactHistory is being called ======\n");    
...
{
printf("================= JCPRINT:FixMeshSurface::deleteContactHistory is being called ======\n");    
    // contact tracker and neighlist are created via fix wall/gran
...
{
printf("================= JCPRINT:FixMeshSurface::createMeshforceContact is being called ======\n");    
...
{
printf("================= JCPRINT:FixMeshSurface::createMeshforceContactStress is being called ======\n");    
...
{
printf("================= JCPRINT:FixMeshSurface::createMulticontactData is being called ======\n");    
...
{
printf("================= JCPRINT:FixMeshSurface::deleteMeshforceContact is being called ======\n");    
    // contact tracker and neighlist are created via fix wall/gran
...
{
printf("================= JCPRINT:FixMeshSurface::deleteMeshforceContactStress is being called ======\n");    
    // contact tracker and neighlist are created via fix wall/gran
...
{
printf("================= JCPRINT:FixMeshSurface::deleteMeshMulticontactData is being called ======\n");    
    // contact tracker and neighlist are created via fix wall/gran
...
{
printf("================= JCPRINT:FixMeshSurface::initVel is being called ======\n");    
...
{
printf("================= JCPRINT:FixMeshSurface::setVel is being called ======\n");    
    if (vSurfStyleX_ == EQUAL)
    {
        modify->clearstep_compute();
        vSurf_[0] = input->variable->compute_equal(vSurfVarX_);
...
{
printf("================= JCPRINT:FixMeshSurface::initAngVel is being called ======\n");    
    // register new element property v - error if exists already via moving mesh
    mesh()->prop().addElementProperty<MultiVectorContainer<double,3,3> >("v","comm_exchange_borders","frame_invariant","restart_no");
...
{
printf("================= JCPRINT:FixMeshSurface::get_module is being called ======\n");    
...
{
printf("================= JCPRINT:FixMeshSurface::add_particle_contribution is being called ======\n");    
    std::vector<std::string>::iterator it;
    for(it = mesh_module_order.begin(); it != mesh_module_order.end(); it++)
...
{
printf("================= JCPRINT:FixMeshSurface::trackStress is being called ======\n");    
...
{
printf("================= JCPRINT:FixMeshSurface::modify_param is being called ======\n");    
    int ret = 0;
