...
{
fprintf(screen,"procmap is being used \n");
}
...
{
printf("================= JCPRINT:ProcMap::onelevel_grid is being called ======\n");
  int **factors;
...
void ProcMap::twolevel_grid(int nprocs, int *user_procgrid, int *procgrid,
                            ...
                            int *other_procgrid, int *other_coregrid)
{
printf("================= JCPRINT:ProcMap::twolevel_grid is being called ======\n");
...
void ProcMap::numa_grid(int nprocs, int *user_procgrid, int *procgrid,
                        int *numagrid)
{
printf("================= JCPRINT:ProcMap::numa_grid is being called ======\n");
...
{
printf("================= JCPRINT:ProcMap::custom_grid is being called ======\n");
  FILE *fp = NULL;
  char line[MAXLINE];
...
{
printf("================= JCPRINT:ProcMap::cart_map is being called ======\n");
  int periods[3];
...
void ProcMap::cart_map(int reorder, int *procgrid, int ncores, int *coregrid,
                       int *myloc, int procneigh[3][2], int ***grid2proc)
{
printf("================= JCPRINT:ProcMap::cart_map1 is being called ======\n");
...
void ProcMap::xyz_map(char *xyz, int *procgrid,
                      int *myloc, int procneigh[3][2], int ***grid2proc)
{
printf("================= JCPRINT:ProcMap::xyz_map is being called ======\n");
  int me;
  MPI_Comm_rank(world,&me);
...
void ProcMap::xyz_map(char *xyz, int *procgrid, int ncores, int *coregrid,
                      int *myloc, int procneigh[3][2], int ***grid2proc)
{
printf("================= JCPRINT:ProcMap::xyz_map1 is being called ======\n");
  int me;
  MPI_Comm_rank(world,&me);
...
void ProcMap::numa_map(int reorder, int *numagrid,
                       int *myloc, int procneigh[3][2], int ***grid2proc)
{
printf("================= JCPRINT:ProcMap::numa_map is being called ======\n");
...
void ProcMap::custom_map(int *procgrid,
                         int *myloc, int procneigh[3][2], int ***grid2proc)
{
printf("================= JCPRINT:ProcMap::custom_map is being called ======\n");
  int me,nprocs;
  MPI_Comm_rank(world,&me);
  MPI_Comm_size(world,&nprocs);
...
{
printf("================= JCPRINT:ProcMap::output is being called ======\n");
  int me,nprocs;
  MPI_Comm_rank(world,&me);
  MPI_Comm_size(world,&nprocs);
...
{
printf("================= JCPRINT:ProcMap::factor is being called ======\n");
  int i,j,nyz;
...
int ProcMap::combine_factors(int n1, int **factors1, int n2, int **factors2,
                             int **factors)
{
printf("================= JCPRINT:ProcMap::combine_factors is being called ======\n");
  int m = 0;
  for (int i = 0; i < n1; i++)
    for (int j = 0; j < n2; j++) {
...
{
printf("================= JCPRINT:ProcMap::cull_2d is being called ======\n");
  int i = 0;
  while (i < n) {
    if (factors[i][2] != 1) {
...
{
printf("================= JCPRINT:ProcMap::cull_user is being called ======\n");
  int i = 0;
  while (i < n) {
    int flag = 0;
...
int ProcMap::cull_other(int n, int **factors, int m,
                        ...
                        int *other_coregrid)
{
printf("================= JCPRINT:ProcMap::cull_other is being called ======\n");
  int i = 0;
  while (i < n) {
...
{
printf("================= JCPRINT:ProcMap::best_factors is being called ======\n");
...
{
printf("================= JCPRINT:ProcMap::grid_shift is being called ======\n");
  minus = myloc - 1;
