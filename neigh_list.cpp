...
fprintf(screen,"neigh_list is being used \n");
}
...
void NeighList::setup_pages(int pgsize_caller, int oneatom_caller,
                            int dnum_caller)
{
printf("====== JCPRINTS: NeighList:: setup_pages  is being called\n");
...
{
printf("====== JCPRINTS: NeighList:: grow  is being called\n");
...
{
printf("====== JCPRINTS: NeighList:: stencil_allocate is being called\n");
  int i;
...
{
printf("====== JCPRINTS: NeighList:: copy_skip_info is being called\n");
...
{
printf("====== JCPRINTS: NeighList:: print_attributes is being called\n");
  if (comm->me != 0) return;
...
{
printf("====== JCPRINTS: NeighList::memory_usage is being called\n");
  bigint bytes = 0;
