...
fprintf(screen,"Fix_insert is being used \n");
}
...
{
printf("================= JCPRINT:FixInsert::setup is being called ======\n");    
  // do this only once
...
{
printf("================= JCPRINT:FixInsert::init_defaults is being called ======\n");    
...
{
printf("================= JCPRINT:FixInsert::sanity_check is being called ======\n");    
...
{
printf("================= JCPRINT:FixInsert::print_stats_start is being called ======\n");    
...
{
printf("================= JCPRINT:FixInsert::print_stats_during is being called ======\n");    
...
{
printf("================= JCPRINT:FixInsert::setmask is being called ======\n");    
  int mask = 0;
  mask |= PRE_EXCHANGE;
  return mask;
}
...
void FixInsert::init()
{
printf("================= JCPRINT:FixInsert::init is being called ======\n");    
...
{
    printf("================= JCPRINT:FixInsert::reset_timestep is being called ======\n");    
...
{
    printf("================= JCPRINT:FixInsert::min_type is being called ======\n");    
    return type_min;
}
...
{
    printf("================= JCPRINT:FixInsert::max_type is being called ======\n");    
    return type_max;
}
...
{
    printf("================= JCPRINT:FixInsert::max_rad is being called ======\n");    
...
{
    printf("================= JCPRINT:FixInsert::min_rad is being called ======\n");    
...
{
    printf("================= JCPRINT:FixInsert::max_r_bound is being called ======\n");    
...
{
    printf("================= JCPRINT:FixInsert::extend_cut_ghost is being called ======\n");    
    if(!fix_multisphere)
        return 0.;
...
{
    printf("================= JCPRINT:FixInsert::calc_ninsert_this is being called ======\n");    
...
{
      printf("================= JCPRINT:FixInsert::pre_exchange is being called ======\n");    
...
{
printf("================= JCPRINT:FixInsert::distribute_ninsert_this is being called ======\n");    
...
{
printf("================= JCPRINT:FixInsert::load_xnear is being called ======\n");    
...
printf("================= JCPRINT:FixInsert::generate_random_velocity is being called ======\n");    
...
{
printf("================= JCPRINT:FixInsert::write_restart is being called ======\n");    
  int n = 0;
  double list[5];
...
{
printf("================= JCPRINT:FixInsert::restart is being called ======\n");    
  int n = 0;
...
{
printf("================= JCPRINT:FixInsert::compute_vector is being called ======\n");    
