...
fprintf(screen,"particleToInsert is being used \n");
}
...
{
  printf("================= JCPRINT: ParticleToInsert::insert() is being called ======\n");
...
{
  printf("================= JCPRINT: ParticleToInsert::check_near_set_x_v_omega  is being called ======\n");
    if(nparticles > 1)
...
{
  printf("================= JCPRINT:ParticleToInsert::check_near_set_x_v_omega_ms  is being called ======\n");
    // x is position where insertion should take place
    // v and omega are the velocity and omega for the newly inserted particles
    double rel[3],xins_j_try[3];
    //double del[3], rsq, radsum;
...
{
  printf("================= JCPRINT: ParticleToInsert::set_x_v_omega  is being called ======\n");
    double rel[3];
...
{
  printf("================= JCPRINT: ParticleToInsert::scale_pti  is being called ======\n");
