...
fprintf(screen,"random_park is being used \n");
}
...
{
//printf("================= JCPRINT:RanPark::uniform is being called ======\n");
  const int k = seed/IQ;
...
{
printf("================= JCPRINT:RanPark::gaussian is being called ======\n");
...
{
printf("================= JCPRINT:RanPark::reset is being called ======\n");
  if (seed_init <= 0)
...
int RanPark::state()
{
printf("================= JCPRINT:RanPark::state is being called ======\n");
  return seed;
}
