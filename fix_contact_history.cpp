...
fprintf(screen,"Fix_contact_history is being used \n");
}
...
{
printf("====== JCPRINTS: FixContactHistory::setmask is being called\n");
  int mask = 0;
  mask |= PRE_EXCHANGE;
...
{
printf("====== JCPRINTS: FixContactHistory::init is being called\n");
...
{
printf("====== JCPRINTS: FixContactHistory:: allocate_pages is being called\n");
  int create = 0;
...
{
printf("====== JCPRINTS: FixContactHistory:: setup_pre_exchange is being called\n");
  if (*computeflag_)
  {
...
{
printf("====== JCPRINTS: FixContactHistory:: pre_exchange is being called\n");
...
{
printf("====== JCPRINTS: FixContactHistory:: min_setup-pre_exchange is being called\n");
  if (*computeflag_)
    pre_exchange();
  // computeflag is re-set in pre_exchange()
}
...
{
printf("====== JCPRINTS: FixContactHistory:: min_pre_exchange is being called\n");
  pre_exchange();
}
...
{
printf("====== JCPRINTS: FixContactHistory::memory_usage is being called\n");
  int nmax = atom->nmax;
...
{
printf("====== JCPRINTS: FixContactHistory:: grow_arrays is being called\n");
...
{
printf("====== JCPRINTS: FixContactHistory:: copy_arrays  is being called\n");
...
{
printf("====== JCPRINTS: FixContactHistory:: set_arrays is being called\n");
  npartner_[i] = 0;
}
...
{
printf("====== JCPRINTS: FixContactHistory:: pack_exchange is being called\n");
...
{
printf("====== JCPRINTS: FixContactHistory:: unpack_exchange is being called\n");
...
{
printf("====== JCPRINTS: FixContactHistory:: write_restart is being called\n");
  int n = 0;
  double list[6];
...
{
printf("====== JCPRINTS: FixContactHistory:: restart is being called\n");
  int n = 0;
...
{
printf("====== JCPRINTS: FixContactHistory:: pack_restart is being called\n");
  int m = 0;
...
{
printf("====== JCPRINTS: FixContactHistory:: unpack_restart is being called\n");
...
{
printf("====== JCPRINTS: FixContactHistory:: maxsize_restart is being called\n");
...
{
printf("====== JCPRINTS: FixContactHistory:: size_restart is being called\n");
