...
{
printf("================= JCPRINT:Comm::set_proc_grid is being called ======\n");
...
void Comm::init()
{
printf("================= JCPRINT:Comm::init is being called ======\n");
...
void Comm::setup()
{
printf("================= JCPRINT:Comm::setup is being called ======\n");
...
{
printf("================= JCPRINT:Comm::updown is being called ======\n");
  int index,count;
  double frac,delta;
...
{
printf("================= JCPRINT:Comm::forward_comm is being called ======\n");
  int n;
  MPI_Request request;
  MPI_Status status;
...
{
printf("================= JCPRINT:Comm::reverse_comm is being called ======\n");
  int n;
  MPI_Request request;
  MPI_Status status;
  AtomVec *avec = atom->avec;
...
void Comm::exchange()
{
printf("================= JCPRINT:Comm::exchange is being called ======\n");
...
void Comm::borders()
{
printf("================= JCPRINT:Comm::borders is being called ======\n");
...
{
printf("================= JCPRINT:Comm::forward_comm_pair is being called ======\n");
  int iswap,n;
  double *buf;
  MPI_Request request;
  MPI_Status status;
...
{
printf("================= JCPRINT:Comm::reverse_comm_pair is being called ======\n");
  int iswap,n;
  double *buf;
  MPI_Request request;
  MPI_Status status;
...
{
printf("================= JCPRINT:Comm::forward_comm_fix is being called ======\n");
  int iswap,n;
  double *buf;
  MPI_Request request;
  MPI_Status status;
...
{
printf("================= JCPRINT:Comm::reverse_comm_fix is being called ======\n");
  int iswap,n;
  double *buf;
  MPI_Request request;
  MPI_Status status;
...
{
printf("================= JCPRINT:Comm::forward_comm_variable_fix is being called ======\n");
  int iswap,n;
  double *buf;
  MPI_Request request;
  MPI_Status status;
...
{
printf("================= JCPRINT:Comm::reverse_comm_variable_fix is being called ======\n");
  int iswap,n;
  double *buf;
  MPI_Request request;
  MPI_Status status;
...
{
printf("================= JCPRINT:Comm::forward_comm_compute is being called ======\n");
  int iswap,n;
  double *buf;
  MPI_Request request;
  MPI_Status status;
...
{
printf("================= JCPRINT:Comm::reverse_comm_compute is being called ======\n");
  int iswap,n;
  double *buf;
  MPI_Request request;
  MPI_Status status;
...
{
printf("================= JCPRINT:Comm::forward_comm_dump is being called ======\n");
  int iswap,n;
  double *buf;
  MPI_Request request;
  MPI_Status status;
...
{
printf("================= JCPRINT:Comm::reverse_comm_dump is being called ======\n");
  int iswap,n;
  double *buf;
  MPI_Request request;
  MPI_Status status;
...
{
printf("================= JCPRINT:Comm::forward_comm_array is being called ======\n");
...
{
printf("================= JCPRINT:Comm::ring is being called ======\n");
  MPI_Request request;
  MPI_Status status;
...
{
printf("================= JCPRINT:Comm::read_lines_from_file is being called ======\n");
  int m;
...
int Comm::read_lines_from_file_universe(FILE *fp, int nlines, int maxline,
                                        char *buf)
{
printf("================= JCPRINT:Comm::read_lines_from_file_universe is being called ======\n");
  int m;
...
{
printf("================= JCPRINT:Comm::grow_send is being called ======\n");
...
{
printf("================= JCPRINT:Comm::grow_recv is being called ======\n");
...
{
printf("================= JCPRINT:Comm::grow_list is being called ======\n");
...
{
printf("================= JCPRINT:Comm::grow_swap is being called ======\n");
  free_swap();
  allocate_swap(n);
  if (style == MULTI) {
    free_multi();
...
{
printf("================= JCPRINT:Comm::allocate_swap is being called ======\n");
...
{
printf("================= JCPRINT:Comm::allocate_multi is being called ======\n");
...
void Comm::free_swap()
{
printf("================= JCPRINT:Comm::free_swap is being called ======\n");
...
{
printf("================= JCPRINT:Comm::free_multi is being called ======\n");
...
{
printf("================= JCPRINT:Comm::set is being called ======\n");
...
{
printf("================= JCPRINT:Comm::set_processors is being called ======\n");
...
{
printf("================= JCPRINT:Comm::memory_usage is being called ======\n");
  bigint bytes = 0;
