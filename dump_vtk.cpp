...
printf("dump_vtk is being used \n");
}

int DumpVTK::modify_param(int narg, char **arg)
{
printf("====== JCPRINTS: DumpVTK::modify_param  is being called\n");
...
{
printf("====== JCPRINTS: DumpVTK::setVtkWriteoptions1  is being called\n");
...
{
printf("====== JCPRINTS: DumpVTK::setVtkWriterOptions2  is being called\n");
    if (binary_)
...
{
printf("====== JCPRINTS: DumpVTK::write_vtp  is being called\n");
...
{
printf("====== JCPRINTS: DumpVTK::write_vtu  is being called\n");
...
{
printf("====== JCPRINTS: DumpVTK::write_vti  is being called\n");
...
{
printf("====== JCPRINTS: DumpVTK::write_vtr  is being called\n");
...
{
printf("====== JCPRINTS: DumpVTK::write_vtk_unstructured_grid  is being called\n");
...
{
printf("====== JCPRINTS: DumpVTK::write_vtk_rectilinear_grid  is being called\n");
    if (vtk_file_format == VTK_FILE_FORMATS::VTK)
    {
...
{
printf("====== JCPRINTS: DumpVTK::write_vtk_poly  is being called\n");
    if (vtk_file_format == VTK_FILE_FORMATS::VTK)
    {
...
{
printf("====== JCPRINTS: DumpVTK:: getLocalController is being called\n");
...
{
printf("====== JCPRINTS: DumpVTK::setFileCurrent  is being called\n");
    delete [] filecurrent;
    filecurrent = NULL;
...
{
printf("====== JCPRINTS: DumpVTK:: identify_file_type  is being called\n");
...
{
printf("====== JCPRINTS: DumpVTK::type_error  is being called\n");
    std::stringstream ss;
