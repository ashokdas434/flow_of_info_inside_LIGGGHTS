...
fprintf(screen,"variable is being used \n");
}
...
{
printf("================= JCPRINT: Variable::set1 is being called ======\n");
...
{
printf("================= JCPRINT: Variable::set2 is being called ======\n");
...
{
printf("================= JCPRINT: Variable::next is being called ======\n");
  int ivar;
...
{
printf("================= JCPRINT: Variable::retrieve is being called ======\n");
  int ivar = find(name);
...
{
printf("================= JCPRINT: Variable::compute_equal is being called ======\n");
...
{
printf("================= JCPRINT: Variable::compute_atom is being called ======\n");
  Tree *tree;
  double *vstore = NULL;
...
{
printf("================= JCPRINT: Variable::find is being called ======\n");
  for (int i = 0; i < nvar; i++)
...
{
printf("================= JCPRINT: Variable::equalstyle is being called ======\n");
...
{
printf("================= JCPRINT: Variable::atomstyle is being called ======\n");
...
{
printf("================= JCPRINT: Variable::remove is being called ======\n");
  delete [] names[n];
...
void Variable::grow()
{
printf("================= JCPRINT: Variable::grow is being called ======\n");
  int old = maxvar;
  maxvar += VARDELTA;
...
{
printf("================= JCPRINT: Variable::copy is being called ======\n");
  int n;
...
{
printf("================= JCPRINT: Variable::evaluate is being called ======\n");
  int op,opprevious;
...
{
printf("================= JCPRINT: Variable::collapse_tree is being called ======\n");
  double arg1,arg2;
...
{
printf("================= JCPRINT: Variable::eval_tree is being called ======\n");
...
{
printf("================= JCPRINT: Variable::free_tree is being called ======\n");
...
{
printf("================= JCPRINT: Variable::find_matching_paren is being called ======\n");
...
{
printf("================= JCPRINT: Variable::int_between_brackets is being called ======\n");
  char *start = ++ptr;
...
{
printf("================= JCPRINT: Variable::math_function is being called ======\n");
...
int Variable::group_function(char *word, char *contents, Tree **tree,
                             ...
                             double *argstack, int &nargstack)
{
printf("================= JCPRINT: Variable::group_function is being called ======\n");
...
{
printf("================= JCPRINT: Variable::region_function is being called ======\n");
...
int Variable::special_function(char *word, char *contents, Tree **tree,
                               ...
                               double *argstack, int &nargstack)
{
printf("================= JCPRINT: Variable::special_function is being called ======\n");
...
void Variable::peratom2global(int flag, char *word,
                              ...
                              double *argstack, int &nargstack)
{
printf("================= JCPRINT: Variable::peratom2global is being called ======\n");
  if (atom->map_style == 0)
    error->all(FLERR,
...
{
printf("================= JCPRINT: Variable::is_atom_vector is being called ======\n");
...
void Variable::atom_vector(char *word, Tree **tree,
                           Tree **treestack, int &ntreestack)
{
printf("================= JCPRINT: Variable::atom_vector is being called ======\n");
  if (tree == NULL)
...
{
printf("================= JCPRINT: Variable::is_constant is being called ======\n");
...
{
printf("================= JCPRINT: Variable::constant is being called ======\n");
...
{
printf("================= JCPRINT: Variable::numeric is being called ======\n");
  int n = strlen(str);
  for (int i = 0; i < n; i++) {
...
{
printf("================= JCPRINT: Variable::inumeric is being called ======\n");
  int n = strlen(str);
  for (int i = 0; i < n; i++) {
...
{
printf("================= JCPRINT: Variable::find_next_comma is being called ======\n");
  int level = 0;
  for (char *p = str; *p; ++p) {
    if ('(' == *p) level++;
    else if (')' == *p) level--;
...
{
printf("================= JCPRINT: Variable::print_tree is being called ======\n");
...
{
printf("================= JCPRINT: Variable::evaluate_boolean is being called ======\n");
  int op,opprevious;
  double value1,value2;
  char onechar;
...
{
printf("================= JCPRINT: Variable::data_mask1 is being called ======\n");
...
{
printf("================= JCPRINT: Variable::data_mask2 is being called ======\n");
...
VarReader::VarReader(LAMMPS *lmp, char *name, char *file, int flag) :
  Pointers(lmp)
{
printf("================= JCPRINT: VarReader::VarReader (Variable.cpp) is being called ======\n");
  me = comm->me;
  style = flag;
...
{
printf("================= JCPRINT: VarReader::read_scalar (Variable.cpp) is being called ======\n");
  int n;
  char *ptr;
...
{
printf("================= JCPRINT: VarReader::read_peratom (Variable.cpp) is being called ======\n");
