...
fprintf(screen,"Fix_move is being used \n");
}
...
int FixMove::setmask()
{
printf("================= JCPRINT:FixMove::setmask is being called ======\n");    
  int mask = 0;
...
void FixMove::init()
{
printf("================= JCPRINT:FixMove::init is being called ======\n");    
  dt = update->dt;
  dtv = update->dt;
...
{
printf("================= JCPRINT:FixMove::initial_integrate is being called ======\n");    
  double dtfm;
...
{
printf("================= JCPRINT:FixMove::final_integrate is being called ======\n");    
  double dtfm;
...
{
printf("================= JCPRINT:FixMove::initial_integrate_respa is being called ======\n");    
...
{
printf("================= JCPRINT:FixMove::final_integrate_respa is being called ======\n");    
...
{
printf("================= JCPRINT:FixMove::memory_usage is being called ======\n");    
...
{
printf("================= JCPRINT:FixMove::write_restart is being called ======\n");    
  int n = 0;
  double list[1];
  list[n++] = time_origin;
...
{
printf("================= JCPRINT:FixMove::restart is being called ======\n");    
  int n = 0;
...
{
printf("================= JCPRINT:FixMove::grow_arrays is being called ======\n");    
...
{
printf("================= JCPRINT:FixMove::copy_arrays is being called ======\n");    
...
{
printf("================= JCPRINT:FixMove::set_arrays is being called ======\n");    
  double **x = atom->x;
  tagint *image = atom->image;
  int *mask = atom->mask;
...
{
printf("================= JCPRINT:FixMove::pack_exchange is being called ======\n");    
  buf[0] = xoriginal[i][0];
  buf[1] = xoriginal[i][1];
  buf[2] = xoriginal[i][2];
  return 3;
...
{
printf("================= JCPRINT:FixMove::unpack_exchange is being called ======\n");    
...
{
printf("================= JCPRINT:FixMove::pack_restart is being called ======\n");    
  buf[0] = 4;
  buf[1] = xoriginal[i][0];
  buf[2] = xoriginal[i][1];
  buf[3] = xoriginal[i][2];
...
{
printf("================= JCPRINT:FixMove::unpack_restart is being called ======\n");    
...
{
printf("================= JCPRINT:FixMove::maxsize_restart is being called ======\n");    
  return 4;
}
...
{
printf("================= JCPRINT:FixMove::size_restart is being called ======\n");    
  return 4;
}
...
{
printf("================= JCPRINT:FixMove::reset_dt is being called ======\n");    
