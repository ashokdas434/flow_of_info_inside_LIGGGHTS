...
FixNVESuperquadric::FixNVESuperquadric(LAMMPS *lmp, int narg, char **arg) :
  FixNVEAsphereBase(lmp, narg, arg)
{
fprintf(screen,"Fix_nve_superquadric is being used \n");
}

/* ---------------------------------------------------------------------- */

void FixNVESuperquadric::init()
{
