...
fprintf(screen,"pair_gran is being used \n");
}
...
{
printf("================= JCPRINT:PairGran::updatePtrs is being called ======\n");
...
{
printf("================= JCPRINT:PairGran::allocate is being called ======\n");
  allocated = 1;
...
{
printf("================= JCPRINT:PairGran::coeff is being called ======\n");
...
{
printf("================= JCPRINT:PairGran::init_style is being called ======\n");
  int i;
...
{
printf("================= JCPRINT:PairGran::register_compute_pair_local is being called ======\n");
...
{
printf("================= JCPRINT:PairGran::unregister_compute_pair_local is being called ======\n");
...
{
printf("================= JCPRINT:PairGran::fix_extra_dnum_index is being called ======\n");
    for(int ifix = 0; ifix < nfix; ifix++)
    {
...
{
printf("================= JCPRINT:PairGran::init_list is being called ======\n");
...
{
printf("================= JCPRINT:PairGran::init_one is being called ======\n");
  if (!allocated) allocate();
...
{
printf("================= JCPRINT:PairGran::compute is being called ======\n");
   if(forceoff()) return;
...
{
printf("================= JCPRINT:PairGran::compute_pgl is being called ======\n");
...
{
printf("================= JCPRINT:PairGran::pack_comm is being called ======\n");
  int i,j,m;
...
{
printf("================= JCPRINT:PairGran::unpack_comm is being called ======\n");
  int i,m,last;
...
{
printf("================= JCPRINT:PairGran::write_restart is being called ======\n");
...
{
printf("================= JCPRINT:PairGran::read_restart is being called ======\n");
...
{
printf("================= JCPRINT:PairGran::reset_dt is being called ======\n");
  dt = update->dt;
}
...
{
printf("================= JCPRINT:PairGran::extract is being called ======\n");
  dim = 0;
...
{
printf("================= JCPRINT:PairGran::memory_usage is being called ======\n");
...
{
printf("================= JCPRINT:PairGran::cpl_add_pair is being called ======\n");
...
{
printf("================= JCPRINT:PairGran::cpl_pair_finalize is being called ======\n");
    cpl_->pair_finalize();
}
