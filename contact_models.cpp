...
{
printf("================= JCPRINT:ContactModelBase::get_history_offset is being called ======\n");
...
{
printf("================= JCPRINT:ContactModelBase::add_history_offset is being called ======\n");
    std::map<std::string, int>::iterator it = history_offsets.find(hname);
