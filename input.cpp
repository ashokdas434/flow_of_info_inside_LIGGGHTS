...
fprintf(screen,"input is being used \n");
}
...
void Input::file()
{
  printf("================= JCPRINT: Input::file is being called ======\n");
  int m,n;
...
{
  printf("================= JCPRINT: Input::one is being called ======\n");
...
void Input::parse()
{
  printf("================= JCPRINT: Input::parse is being called ======\n");
...
{
  printf("================= JCPRINT: Input::nextword is being called ======\n");
  char *start,*stop;
...
{
  printf("================= JCPRINT: Input::substitute is being called ======\n");
...
{
  printf("================= JCPRINT: Input::reallocate is being called ======\n");
  if (n) {
...
{
  printf("================= JCPRINT: Input::execute_command is being called ======\n");
  int flag = 1;
...
{
  printf("================= JCPRINT: Input::command_creator is being called ======\n");
  T cmd(lmp);
...
void Input::clear()
{
  printf("================= JCPRINT: Input::clear is being called ======\n");
...
void Input::echo()
{
  printf("================= JCPRINT: Input::echo is being called ======\n");
...
{
  printf("================= JCPRINT: Input::ifthenelse is being called ======\n");
...
void Input::include()
{
  printf("================= JCPRINT: Input::include is being called ======\n");
...
void Input::jump()
{
  printf("================= JCPRINT: Input::jump is being called ======\n");
...
void Input::label()
{
  printf("================= JCPRINT: Input::label is being called ======\n");
...
void Input::log()
{
  printf("================= JCPRINT: Input::log is being called ======\n");
...
{
  printf("================= JCPRINT: Input::thermo_log is being called ======\n");
...
{
  printf("================= JCPRINT: Input::next_command is being called ======\n");
...
void Input::print()
{
  printf("================= JCPRINT: Input::print is being called ======\n");
    if (narg < 1)
...
void Input::quit()
{
  printf("================= JCPRINT: Input::quit is being called ======\n");
...
void Input::shell()
{
  printf("================= JCPRINT: Input::shell is being called ======\n");
...
{
  printf("================= JCPRINT: Input::variable_command is being called ======\n");
...
{
  printf("================= JCPRINT: Input::angle_coeff is being called ======\n");
...
{
  printf("================= JCPRINT: Input::angle_style is being called ======\n");
...
{
  printf("================= JCPRINT: Input::atom_modify is being called ======\n");
...
{
  printf("================= JCPRINT: Input::atom_style is being called ======\n");
...
{
  printf("================= JCPRINT: Input::bond_coeff is being called ======\n");
  if (domain->box_exist == 0)
...
{
  printf("================= JCPRINT: Input::bond_style is being called ======\n");
...
void Input::boundary()
{
  printf("================= JCPRINT: Input::boundary is being called ======\n");
  if (domain->box_exist)
...
void Input::box()
{
  printf("================= JCPRINT: Input::box is being called ======\n");
  if (domain->box_exist)
...
{
  printf("================= JCPRINT: Input::communicate is being called ======\n");
  comm->set(narg,arg);
}
...
void Input::compute()
{
  printf("================= JCPRINT: Input::compute is being called ======\n");
...
{
  printf("================= JCPRINT: Input::compute_modify is being called ======\n");
...
{
  printf("================= JCPRINT: Input::dielectric is being called ======\n");
...
{
  printf("================= JCPRINT: Input::dihedral_coeff is being called ======\n");
  if (domain->box_exist == 0)
...
{
  printf("================= JCPRINT: Input::dihedral_style is being called ======\n");
...
{
  printf("================= JCPRINT: Input::dimension is being called ======\n");
...
void Input::dump()
{
  printf("================= JCPRINT: Input::dump is being called ======\n");
...
{
  printf("================= JCPRINT: Input::dump_modify is being called ======\n");
...
void Input::fix()
{
  printf("================= JCPRINT: Input::fix is being called ======\n");
...
{
  printf("================= JCPRINT: Input::fix_modify is being called ======\n");
...
{
  printf("================= JCPRINT: Input::force_dt_reset is being called ======\n");
   if(narg != 1)
...
{
  printf("================= JCPRINT: Input::group_command is being called ======\n");
...
{
  printf("================= JCPRINT: Input::improper-coeff is being called ======\n");
  if (domain->box_exist == 0)
...
{
  printf("================= JCPRINT: Input::improper_style is being called ======\n");
...
{
  printf("================= JCPRINT: Input::kspace_modify is being called ======\n");
...
{
  printf("================= JCPRINT: Input::kspace_style is being called ======\n");
...
void Input::lattice()
{
  printf("================= JCPRINT: Input::lattice is being called ======\n");
...
void Input::mass()
{
  printf("================= JCPRINT: Input::mass is being called ======\n");
...
{
  printf("================= JCPRINT: Input::min_modify is being called ======\n");
...
{
  printf("================= JCPRINT: Input::min_style is being called ======\n");
  if (domain->box_exist == 0)
...
{
  printf("================= JCPRINT: Input::neighbor_command is being called ======\n");
...
void Input::newton()
{
  printf("================= JCPRINT: Input::newton is being called ======\n");
...
{
  printf("================= JCPRINT: Input::modify_timing is being called ======\n");
  int timing = 0;
...
void Input::package()
{
  printf("================= JCPRINT: Input:package is being called ======\n");
  if (domain->box_exist)
...
{
  printf("================= JCPRINT: Input::pair_coeff is being called ======\n");
  if (domain->box_exist == 0)
...
{
  printf("================= JCPRINT: Input:: pair_modifyis being called ======\n");
  if (force->pair == NULL)
...
{
  printf("================= JCPRINT: Input:: pair_style is being called ======\n");
...
{
  printf("================= JCPRINT: Input::pair_write is being called ======\n");
  if (force->pair == NULL)
...
{
  printf("================= JCPRINT: Input::processors is being called ======\n");
  if (domain->box_exist)
...
void Input::region()
{
  printf("================= JCPRINT: Input:: region is being called ======\n");
...
{
  printf("================= JCPRINT: Input:: reset_timestep is being called ======\n");
...
void Input::restart()
{
  printf("================= JCPRINT: Input:: restart is being called ======\n");
...
{
  printf("================= JCPRINT: Input:: run_style is being called ======\n");
  if (domain->box_exist == 0)
...
{
  printf("================= JCPRINT: Input:: write_restart_on_signal is being called ======\n");
   if(narg != 1)
...
{
  printf("================= JCPRINT: Input:: hart_particles is being called ======\n");
   if(narg != 1)
...
{
  printf("================= JCPRINT: Input:: soft_particles is being called ======\n");
   if(narg != 1)
...
{
  printf("================= JCPRINT: Input:: special_bonds is being called ======\n");
...
void Input::suffix()
{
  printf("================= JCPRINT: Input:: suffix is being called ======\n");
...
void Input::thermo()
{
  printf("================= JCPRINT: Input:: thermo is being called ======\n");
...
{
  printf("================= JCPRINT: Input:: thermo_modify is being called ======\n");
...
{
  printf("================= JCPRINT: Input:: thermo_style is being called ======\n");
...
void Input::timestep()
{
  printf("================= JCPRINT: Input:: timestep is being called ======\n");
...
{
  printf("================= JCPRINT: Input:: uncompute is being called ======\n");
...
void Input::undump()
{
  printf("================= JCPRINT: Input:: undump is being called ======\n");
...
void Input::unfix()
{
  printf("================= JCPRINT: Input:: unfix is being called ======\n");
...
void Input::units()
{
  printf("================= JCPRINT: Input:: units is being called ======\n");
...
{
  printf("================= JCPRINT: Input:: parse_nonlammps is being called ======\n");
  // duplicate line into copy string to break into words
