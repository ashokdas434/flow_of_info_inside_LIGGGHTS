...
fprintf(screen,"min_linesearch is being used \n");
}
...
{
printf("================= JCPRINT:MinLineSearch::init is being called ======\n");
  Min::init();
...
{
printf("================= JCPRINT:MinLineSearch::setup_style is being called ======\n");
...
{
printf("================= JCPRINT:MinLineSearch::reset_vectors is being called ======\n");
  // atomic dof
...
{
printf("================= JCPRINT:MinLineSearch::linemin_backtrack is being called ======\n");
  int i,m,n;
...
{
printf("================= JCPRINT:MinLineSearch::linemin_quadratic is being called ======\n");
  int i,m,n;
  double fdothall,fdothme,hme,hmax,hmaxall;
  double de_ideal,de;
...
{
printf("================= JCPRINT:MinLineSearch::linemin_forcezero is being called ======\n");
  int i,m,n;
  double fdothall,fdothme,hme,hmax,hmaxall;
  double de; 
  double *xatom,*x0atom,*fatom,*hatom;
...
{
printf("================= JCPRINT:MinLineSearch::alpha_step is being called ======\n");
  int i,n,m;
...
{
printf("================= JCPRINT:MinLineSearch::compute_dir_deriv is being called ======\n");
   int i,m,n;
   double *hatom, *fatom; 
   double dot[2],dotall[2];
   double fh;
