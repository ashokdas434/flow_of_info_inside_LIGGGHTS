...
fprintf(screen,"modify is being used \n");
}
...
void Modify::init()
{
printf("================= JCPRINT:Modify::init is being called ======\n");
  int i,j;
...
{
printf("================= JCPRINT:Modify::setup is being called ======\n"); 
  int nlocal = atom->nlocal;
  int *mask = atom->mask;
...
{
printf("================= JCPRINT:Modify::setup_pre_exchange is being called ======\n");
  if (update->whichflag <= 1)
...
{
printf("================= JCPRINT:Modify::setup_pre_neighbor is being called ======\n");
  if (update->whichflag == 1)
...
{
printf("================= JCPRINT:Modify::setup_pre_force is being called ======\n");
  if (update->whichflag == 1) {
...
{
printf("================= JCPRINT:Modify::pre_initial_integrate is being called ======\n");
...
{
printf("================= JCPRINT:Modify::initial_integrate is being called ======\n");
...
{
printf("================= JCPRINT:Modify::post_integrate is being called ======\n");
...
{
printf("================= JCPRINT:Modify::pre_exchange is being called ======\n");
...
{
printf("================= JCPRINT:Modify::pre_neighbor is being called ======\n");
...
{
printf("================= JCPRINT:Modify::pre_force is being called ======\n");
...
{
printf("================= JCPRINT:Modify::post_force is being called ======\n");
...
{
printf("================= JCPRINT:Modify::iterate_implicitly is being called ======\n");
...
{
printf("================= JCPRINT:Modify::pre_final_integrate is being called ======\n");
...
{
printf("================= JCPRINT:Modify::final_integrate is being called ======\n");
...
{
printf("================= JCPRINT:Modify::end_of_step is being called ======\n");
  if(timing) {
...
{
printf("================= JCPRINT:Modify::thermo_energy is being called ======\n");
  double energy = 0.0;
  if(timing) {
...
{
printf("================= JCPRINT:Modify::post_run is being called ======\n");
...
{
printf("================= JCPRINT:Modify::setup_pre_force_respa is being called ======\n");
...
{
printf("================= JCPRINT:Modify::initial_integrate_respa is being called ======\n");
...
{
printf("================= JCPRINT:Modify::post_integrate_respa is being called ======\n");
...
{
printf("================= JCPRINT:Modify::pre_force_respa is being called ======\n");
...
{
printf("================= JCPRINT:Modify::post_force_respa is being called ======\n");
...
{
printf("================= JCPRINT:Modify::final_integrate_respa is being called ======\n");
...
{
printf("================= JCPRINT:Modify::min_pre_exchange is being called ======\n");
...
{
printf("================= JCPRINT:Modify::min_pre_neighbor is being called ======\n");
...
{
printf("================= JCPRINT:Modify::min_pre_force is being called ======\n");
...
{
printf("================= JCPRINT:Modify::min_post_force is being called ======\n");
...
{
printf("================= JCPRINT:Modify::min_energy is being called ======\n");
  int ifix,index;
...
{
printf("================= JCPRINT:Modify::min_pre_store is being called ======\n");
...
{
printf("================= JCPRINT:Modify::min_step is being called ======\n");
  int ifix,index;
...
{
printf("================= JCPRINT:Modify::max_alpha is being called ======\n");
  int ifix,index;
...
int Modify::min_dof()
{
printf("================= JCPRINT:Modify::min_dof is being called ======\n");
  int ndof = 0;
  for (int i = 0; i < n_min_energy; i++)
...
{
printf("================= JCPRINT:Modify::min_reset_ref is being called ======\n");
  int itmp,itmpall;
  itmpall = 0;
  for (int i = 0; i < n_min_energy; i++) {
...
{
printf("================= JCPRINT:Modify::add_fix is being called ======\n");
...
{
printf("================= JCPRINT:Modify::modify_fix is being called ======\n");
...
{
printf("================= JCPRINT:Modify::delete_fix is being called ======\n");
...
{
printf("================= JCPRINT:Modify::find_fix is being called ======\n");
  int ifix;
  for (ifix = 0; ifix < nfix; ifix++)
...
{
printf("================= JCPRINT:Modify::add_compute is being called ======\n");
...
{
printf("================= JCPRINT:Modify::modify_compute is being called ======\n");
...
{
printf("================= JCPRINT:Modify::delete_compute is being called ======\n");
...
{
printf("================= JCPRINT:Modify::find_compute is being called ======\n");
  int icompute;
  for (icompute = 0; icompute < ncompute; icompute++)
...
{
printf("================= JCPRINT:Modify::clearstep_compute is being called ======\n");
  for (int icompute = 0; icompute < ncompute; icompute++)
...
{
printf("================= JCPRINT:Modify::addstep_compute is being called ======\n");
...
{
printf("================= JCPRINT:Modify::addstep_compute_all is being called ======\n");
  for (int icompute = 0; icompute < ncompute; icompute++)
...
{
printf("================= JCPRINT:Modify::write_restart is being called ======\n");
  int me = comm->me;
...
{
printf("================= JCPRINT:Modify::read_restart is being called ======\n");
...
{
 printf("================= JCPRINT:Modify::restart_deallocate is being called ======\n");
...
{
 printf("================= JCPRINT:Modify::list_init is being called ======\n");
  delete [] list;
...
{
printf("================= JCPRINT:Modify::list_init_pre_exchange is being called ======\n");
  delete [] list;
...
{
printf("================= JCPRINT:Modify::list_init_end_of_step is being called ======\n");
  delete [] list;
  delete [] end_of_step_every;
...
{
printf("================= JCPRINT:Modify::list_init_thermo_energy is being called ======\n");
  delete [] list;
...
{
printf("================= JCPRINT:Modify::list_init_compute is being called ======\n");
  delete [] list_timeflag;
...
{
printf("================= JCPRINT:Modify::memory_usage is being called ======\n");
  bigint bytes = 0;
  for (int i = 0; i < nfix; i++)
...
printf("================= JCPRINT:Modify::call_method_on_fixes1 is being called ======\n");
  if(timing) {
    for (int i = 0; i < nfix; i++) {
...
printf("================= JCPRINT:Modify::call_method_on_fixes2 is being called ======\n");
  if(timing) {
  ...
  {
    printf("Enters the else loop with inum = %d\n",inum);
    for (int i = 0; i < inum; i++) {
    printf("Running the for loop with i = %d",i);
      (fix[ilist[i]]->*method)();
    }
    printf("For loop ends\n");
  }
    printf("Control Returns\n");
}
...
printf("================= JCPRINT:Modify::call_method_on_fixes3 is being called ======\n");
  if(timing) {
    for (int i = 0; i < nfix; i++) {
      fix[i]->begin_time_recording();
      (fix[i]->*method)(vflag);
...
printf("================= JCPRINT:Modify::call_method_on_fixes4 is being called ======\n");
  if(timing) {
    for (int i = 0; i < inum; i++) {
      const int ifix = ilist[i];
      fix[ifix]->begin_time_recording();
  ...
  else
  {
    printf("Enters the else loop with inum = %d\n",inum);
    for (int i = 0; i < inum; i++) {
    printf("Running the for loop with i = %d and vflag = %d\n",i,vflag);
...
printf("================= JCPRINT:Modify::call_mrespa_ethod_on_fixes1 is being called ======\n");
  if(timing) {
    for (int i = 0; i < inum; i++) {
      const int ifix = ilist[i];
      fix[ifix]->begin_time_recording();
...
printf("================= JCPRINT:Modify::call_respa_method_on_fixes2 is being called ======\n");
  if(timing) {
    for (int i = 0; i < inum; i++) {
      const int ifix = ilist[i];
      fix[ifix]->begin_time_recording();
...
{
printf("================= JCPRINT:Modify::update_computes_on_run_end is being called ======\n");
    for (int i = 0; i < ncompute; i++)
    {
