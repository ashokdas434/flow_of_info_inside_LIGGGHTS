...
fprintf(screen,"dump_custom_vtk is being used \n");
}
...
{
printf("====== JCPRINTS: DumpCustomVTK::init_style   is being called\n");
...
{
printf("====== JCPRINTS: DumpCustomVTK:: write_header   is being called\n");
}
...
{
printf("====== JCPRINTS: DumpCustomVTK:: header_vtk  is being called\n");
}
...
{
printf("====== JCPRINTS: DumpCustomVTK:: count  is being called\n");
...
{
printf("====== JCPRINTS: DumpCustomVTK:: write  is being called\n");
  nme = count();
...
{
printf("====== JCPRINTS: DumpCustomVTK:: write_data  is being called\n");
...
{
printf("====== JCPRINTS: DumpCustomVTK:: setFileCurrent  is being called\n");
...
{
printf("====== JCPRINTS: DumpCustomVTK:: :write_domain_vtk  is being called\n");
...
{
printf("====== JCPRINTS: DumpCustomVTK:: write_domain_vtk_triclinic  is being called\n");
...
{
printf("====== JCPRINTS: DumpCustomVTK:: write_domain_vtr  is being called\n");
    vtkSmartPointer<vtkDataObject> rgrid = mbSet->GetBlock(1);
...
{
printf("====== JCPRINTS: DumpCustomVTK:: write_domain_vtu_triclinic  is being called\n");
    vtkSmartPointer<vtkDataObject> hexahedronGrid = mbSet->GetBlock(1);
...
{
printf("====== JCPRINTS: DumpCustomVTK:: write_vtk  is being called\n");
    setFileCurrent();
...
{
printf("====== JCPRINTS: DumpCustomVTK:: write_vtp  is being called\n");
    setFileCurrent();
...
{
printf("====== JCPRINTS: DumpCustomVTK:: write_vtu  is being called\n");
    setFileCurrent();
...
{
printf("====== JCPRINTS: DumpCustomVTK::   modify_param is being called\n");
...
{
printf("====== JCPRINTS: DumpCustomVTK::memory_usage   is being called\n");
