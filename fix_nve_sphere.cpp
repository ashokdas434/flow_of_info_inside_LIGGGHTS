  ...
  onePlusCAddRhoFluid_(1.0)
{
  ...
  if (extra == DIPOLE && !atom->mu_flag)
   ...
   fprintf(screen,"Fix_nve_sphere is being used \n");
}
...
{
printf("================= JCPRINT:FixNVESphere::init is being called ======\n");    
  FixNVE::init();
...
{
printf("================= JCPRINT:FixNVESphere::initial_integrate is being called ======\n");    
...
{
printf("================= JCPRINT:FixNVESphere::final_integrate is being called ======\n");    
