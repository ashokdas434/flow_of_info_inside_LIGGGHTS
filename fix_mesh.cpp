...
fprintf(screen,"Fix_mesh is being used \n");
}
...
{
printf("================= JCPRINT:FixMesh::handle_exclusion_list is being called ======\n");    
...
{
printf("================= JCPRINT:FixMesh::post_create is being called ======\n");    
...
{
printf("================= JCPRINT:FixMesh::create_mesh is being called ======\n");    
...
{
printf("================= JCPRINT:FixMesh::create_mesh_restart is being called ======\n");    
...
{
printf("================= JCPRINT:FixMesh::pre_delete is being called ======\n");    
...
void FixMesh::init()
{
printf("================= JCPRINT:FixMesh::init is being called ======\n");    
...
int FixMesh::setmask()
{
printf("================= JCPRINT:FixMesh::setmask is being called ======\n");    
    int mask = 0;
    mask |= PRE_EXCHANGE;
    mask |= PRE_FORCE;
...
{
printf("================= JCPRINT:FixMesh::setup_pre_force is being called ======\n");    
    // first-time set-up
...
{
printf("================= JCPRINT:FixMesh::setup is being called ======\n");    
...
{
printf("================= JCPRINT:FixMesh::initialSetup is being called ======\n");    
...
{
printf("================= JCPRINT:FixMesh::pre_exchange is being called ======\n");    
...
{
printf("================= JCPRINT:FixMesh::pre_force is being called ======\n");    
    // case re-neigh step
    if(pOpFlag_)
    {
...
{
printf("================= JCPRINT:FixMesh::final_integrate is being called ======\n");    
...
{
printf("================= JCPRINT:FixMesh::min_type is being called ======\n");    
...
{
printf("================= JCPRINT:FixMesh::max_type is being called ======\n");    
    if(atom_type_mesh_ == -1) return 1;
    return atom_type_mesh_;
}
...
{
printf("================= JCPRINT:FixMesh::moveMesh is being called ======\n");    
    if (comm->me == 0)
    {
...
{
printf("================= JCPRINT:FixMesh::rotateMesh is being called ======\n");    
...
{
printf("================= JCPRINT:FixMesh::scaleMesh is being called ======\n");    
    if (comm->me == 0){
...
{
printf("================= JCPRINT:FixMesh::write_restart is being called ======\n");    
...
{
printf("================= JCPRINT:FixMesh::restart is being called ======\n");    
...
{
printf("================= JCPRINT:FixMesh::box_extent is being called ======\n");    
    double node[3];
    int size = mesh()->size();
...
{
printf("================= JCPRINT:FixMesh::move is being called ======\n");    
    mesh_->move(dx);
...
{
printf("================= JCPRINT:FixMesh::rotate is being called ======\n");    
