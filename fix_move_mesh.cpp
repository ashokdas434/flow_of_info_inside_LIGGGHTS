...
fprintf(screen,"Fix_move_mesh is being used \n");
}
...
{
printf("================= JCPRINT:FixMoveMesh::post_create is being called ======\n");    
...
{
printf("================= JCPRINT:FixMoveMesh::pre_delete is being called ======\n");    
...
{
printf("================= JCPRINT:FixMoveMesh::setmask is being called ======\n");    
    int mask = 0;
...
{
printf("================= JCPRINT:FixMoveMesh::init is being called ======\n");    
...
{
printf("================= JCPRINT:FixMoveMesh::setup is being called ======\n");    
...
{
printf("================= JCPRINT:FixMoveMesh::initial_integrate is being called ======\n");    
    MultiVectorContainer<double,3,3> *v;
...
{
printf("================= JCPRINT:FixMoveMesh::final_integrate is being called ======\n");    
    double dt = update->dt;
...
{
printf("================= JCPRINT:FixMoveMesh::write_restart is being called ======\n");    
  int n = 0;
...
{
printf("================= JCPRINT:FixMoveMesh::restart is being called ======\n");    
  int n = 0;
...
{
printf("================= JCPRINT:FixMoveMesh::add_reference_point is being called ======\n");    
    char refpt_id[200];
    sprintf(refpt_id, "REFPT_%s",id);
...
{
printf("================= JCPRINT:FixMoveMesh::get_reference_point is being called ======\n");    
...
{
printf("================= JCPRINT:FixMoveMesh::reset_reference_point is being called ======\n");    
...
{
printf("================= JCPRINT:FixMoveMesh::move is being called ======\n");    
    move_->move(dx);
}
...
{
printf("================= JCPRINT:FixMoveMesh::rotate is being called ======\n");    
