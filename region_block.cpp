...
fprintf(screen,"region_block is being used \n");
}
...
{
printf("================= JCPRINT:RegBlock::inside is being called ======\n");    
...
{
printf("================= JCPRINT:RegBlock::surface_interior is being called ======\n");    
  double delta;
...
{
printf("================= JCPRINT:RegBlock::surface_exterior is being called ======\n");    
  double xp,yp,zp;
