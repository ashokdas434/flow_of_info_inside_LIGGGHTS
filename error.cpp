...
{
//fprintf(screen,"error is being used \n");
printf("error is being used \n");
}
...
{
printf("================= JCPRINT:Error::universe_all is being called ======\n");        
...
{
printf("================= JCPRINT:Error::universe_one is being called ======\n");        
  if (universe->uscreen)
...
{
printf("================= JCPRINT:Error::universe_warn is being called ======\n");        
  if (universe->uscreen)
...
{
printf("================= JCPRINT:Error::all is being called ======\n");        
  MPI_Barrier(world);
...
{
printf("================= JCPRINT:Error::fix_error1 is being called ======\n");        
...
{
printf("================= JCPRINT:Error::fix_error2 is being called ======\n");        
  MPI_Barrier(world);
...
{
printf("================= JCPRINT:Error::compute_error is being called ======\n");        
  MPI_Barrier(world);
...
{
printf("================= JCPRINT:Error::cg is being called ======\n");        
...
{
printf("================= JCPRINT:Error::one is being called ======\n");        
  int me;
  MPI_Comm_rank(world,&me);
  if (screen)
  {
...
{
printf("================= JCPRINT:Error::warning is being called ======\n");        
...
{
printf("================= JCPRINT:Error::warningAll is being called ======\n");        
  MPI_Barrier(world);
...
{
printf("================= JCPRINT:Error::message is being called ======\n");        
  if (screen) fprintf(screen,"%s (%s:%d)\n",str,file,line);
...
void Error::done()
{
printf("================= JCPRINT:Error::done is being called ======\n");        
  MPI_Barrier(world);
