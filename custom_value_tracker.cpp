...
using namespace LAMMPS_NS;
  ...
  {
fprintf(screen,"custom_value_tracker is being used \n");
  }
...
fprintf(screen,"custom_value_tracker is being used \n");
  ...
  {
printf("=================JCPRINT:CustomValueTracker::check_element_property_consistency is being called  ======\n");
  ...
  {
printf("=================JCPRINT:CustomValueTracker::removeElementProperty is being called  ======\n");
     elementProperties_.remove(_id);
  }

  void CustomValueTracker::removeGlobalProperty(const char *_id)
  {
printf("=================JCPRINT:CustomValueTracker::removeGlobalProperty is being called  ======\n");
  ...
  {
printf("=================JCPRINT:CustomValueTracker::storeOrig is being called  ======\n");
  ...
  {
printf("=================JCPRINT:CustomValueTracker::resetToOrig is being called  ======\n");
  ...
  {
printf("=================JCPRINT:CustomValueTracker::calcStatistics is being called  ======\n");
      return elementProperties_.calcStatistics();
  }

  void CustomValueTracker::setWeightingFactor(double _weighting_factor)
  {
printf("=================JCPRINT:CustomValueTracker::setWeightingFactor is being called  ======\n");
  ...
  {
printf("=================JCPRINT:CustomValueTracker::rotate1 is being called  ======\n");
  ...
  {
printf("=================JCPRINT:CustomValueTracker::rotate2 is being called  ======\n");
  ...
  {
printf("=================JCPRINT:CustomValueTracker::scale is being called  ======\n");
  ...
  {
printf("=================JCPRINT:CustomValueTracker::move1 is being called  ======\n");
  ...
  {
printf("=================JCPRINT:CustomValueTracker::move2 is being called  ======\n");
  ...
  {
printf("=================JCPRINT:CustomValueTracker::clearReverse is being called  ======\n");
