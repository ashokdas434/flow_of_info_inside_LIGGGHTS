...
fprintf(screen,"region is being used \n");
}
...
void Region::init()
{
printf("================= JCPRINT:Region::init is being called ======\n");
  seed = 3012211;
...
{
printf("================= JCPRINT:Region::dynamic_check is being called ======\n");
  return dynamic;
}
...
{
printf("================= JCPRINT:Region::prematch is being called ======\n");
...
{
printf("================= JCPRINT:Region::match is being called ======\n");
...
{
printf("================= JCPRINT:Region::surface is being called ======\n");
  int ncontact;
  double xs,ys,zs;
...
{
printf("================= JCPRINT:Region::add_contact is being called ======\n");
  double delx = x[0] - xp;
  double dely = x[1] - yp;
  double delz = x[2] - zp;
...
{
printf("================= JCPRINT:Region::pretransform is being called ======\n");
  if (moveflag) {
...
{
printf("================= JCPRINT:Region::forward_transform is being called ======\n");
  if (rotateflag) {
...
{
printf("================= JCPRINT:Region::inverse_transform is being called ======\n");
  if (moveflag) {
    if (update->ntimestep != lastdynamic) {
      if (xstr) dx = input->variable->compute_equal(xvar);
      if (ystr) dy = input->variable->compute_equal(yvar);
...
{
printf("================= JCPRINT:Region::rotate is being called ======\n");
...
{
printf("================= JCPRINT:Region::options is being called ======\n");
...
{
printf("================= JCPRINT:Region::reset_random is being called ======\n");
...
{
printf("================= JCPRINT:Region::rand_bounds is being called ======\n");
...
{
printf("================= JCPRINT:Region::generate_random is being called ======\n");
...
{
printf("================= JCPRINT:Region::generate_random_shrinkby_cut is being called ======\n");    
    double lo[3],hi[3],diff[3];
    rand_bounds(subdomain_flag,lo,hi);
    vectorSubtract3D(hi,lo,diff);
...
{
printf("================= JCPRINT:Region::generate_random_expandby_cut is being called ======\n");    
    double lo[3],hi[3],diff[3];
    rand_bounds(subdomain_flag,lo,hi);
    vectorSubtract3D(hi,lo,diff);
...
{
printf("================= JCPRINT:Region::match_cut is being called ======\n");    
  double x[3]; 
  vectorCopy3D(pos,x);
...
{
printf("================= JCPRINT:Region::match_expandby_cut is being called ======\n");    
  double x[3]; 
  vectorCopy3D(pos,x);
...
{
printf("================= JCPRINT:Region::match_shrinkby_cut is being called ======\n");    
  double x[3]; 
  vectorCopy3D(pos,x);
...
{
printf("================= JCPRINT:Region::volume_mc is being called ======\n");    
...
{
printf("================= JCPRINT:Region::bbox_extends_outside_box is being called ======\n");    
    double min[3],max[3];
