  ...
  fix_template_(NULL)
{
  ...
  nevery = 1;
fprintf(screen,"fix_insert_stream is being used \n");
}
...
{
  printf("================= JCPRINT:FixInsertStream::post_create()  is being called ======\n");
...
{
  printf("================= JCPRINT: FixInsertStream::pre_delete is being called ======\n");
...
{
  printf("================= JCPRINT: FixInsertStream::init_defaults  is being called ======\n");
...
{
  printf("================= JCPRINT: FixInsertStream::register_tracer_callback  is being called ======\n");
...
{
  printf("================= JCPRINT:FixInsertStream::calc_insertion_properties  is being called ======\n");
...
{
  printf("================= JCPRINT:FixInsertStream::setmask  is being called ======\n");
...
{
  printf("================= JCPRINT:FixInsertStream::init  is being called ======\n");
...
{
  printf("================= JCPRINT:FixInsertStream::insertion_fraction  is being called ======\n");
...
{
  printf("================= JCPRINT:FixInsertStream::calc_ins_fraction  is being called ======\n");
...
{
  printf("================= JCPRINT: FixInsertStream::pre_insert is being called ======\n");
...
{
  printf("================= JCPRINT:FixInsertStream::is_nearby  is being called ======\n");
...
{
 // printf("================= JCPRINT:FixInsertStream::generate_random  is being called ======\n");
    double r, ext[3];
...
{
 // printf("================= JCPRINT:FixInsertStream::generate_random_global  is being called ======\n");
    double r, ext[3];
...
{
  printf("================= JCPRINT:FixInsertStream::x_v_omega  is being called ======\n");
...
{
  printf("================= JCPRINT: FixInsertStream::finalize_insertion is being called ======\n");
...
{
  //printf("================= JCPRINT:FixInsertStream::end_of_step  is being called ======\n");
    int r_step, i_step;
...
{
  printf("================= JCPRINT: FixInsertStream::reset_timestep is being called ======\n");
...
{
  printf("================= JCPRINT: FixInsertStream::reset_releasedata is being called ======\n");
...
{
  printf("================= JCPRINT: FixInsertStream::recalc_release_restart is being called ======\n");
