  ...
  Fix(lmp, narg, arg)
{
  ...
  printf("fix_property_global is being used \n");
}
...
{
printf("================= JCPRINT: FixPropertyGlobal::check_fix is being called ======\n");
    char errmsg[400];
...
{
printf("================= JCPRINT: FixPropertyGlobal::init is being called ======\n");
    me = comm->me;
...
{
printf("================= JCPRINT: FixPropertyGlobal::grow is being called ======\n");
...
{
printf("================= JCPRINT: FixPropertyGlobal::compute_scalar is being called ======\n");
  return values[0];
}
...
{
printf("================= JCPRINT: FixPropertyGlobal::compute_vector is being called ======\n");
...
{
printf("================= JCPRINT: FixPropertyGlobal::vector_modify is being called ======\n");
    if (i>(nvalues-1))error->fix_error(FLERR,this,"Trying to access vector, but index out of bounds");
...
{
printf("================= JCPRINT: FixPropertyGlobal::compute_vector_modified is being called ======\n");
    if (i>(nvalues-1))error->fix_error(FLERR,this,"Trying to access vector, but index out of bounds");
...
{
printf("================= JCPRINT: FixPropertyGlobal::compute_array is being called ======\n");
...
{
printf("================= JCPRINT: FixPropertyGlobal::array_modify is being called ======\n");
    if (i>(size_array_rows-1))error->fix_error(FLERR,this,"Trying to access matrix, but row index out of bounds");
    if (j>(size_array_cols-1))error->fix_error(FLERR,this,"Trying to access matrix, but column index out of bounds");
...
{
printf("================= JCPRINT: FixPropertyGlobal::compute_array_modified is being called ======\n");
    if (i>(size_array_rows-1))error->fix_error(FLERR,this,"Trying to access matrix, but row index out of bounds");
    if (j>(size_array_cols-1))error->fix_error(FLERR,this,"Trying to access matrix, but column index out of bounds");
...
{
printf("================= JCPRINT: FixPropertyGlobal::setmask is being called ======\n");
  int mask = 0;
  return mask;
}
...
{
printf("================= JCPRINT: FixPropertyGlobal::memory_usage is being called ======\n");
...
{
printf("================= JCPRINT: FixPropertyGlobal::new_array is being called ======\n");
...
{
printf("================= JCPRINT: FixPropertyGlobal::write is being called ======\n");
...
{
printf("================= JCPRINT: FixPropertyGlobal::modify_param is being called ======\n");
