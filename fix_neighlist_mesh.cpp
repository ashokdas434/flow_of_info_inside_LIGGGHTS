...
fprintf(screen,"Fix_neighlist_mesh is being used \n");
}
...
{
printf("================= JCPRINT:FixNeighlistMesh::post_create is being called ======\n");
    // register
    if(!fix_nneighs_)
    {
        const char* fixarg[9];
...
{
printf("================= JCPRINT:FixNeighlistMesh::initializeNeighlist is being called ======\n");
...
{
printf("================= JCPRINT:FixNeighlistMesh::setup_pre_force is being called ======\n");
    pre_neighbor();
    pre_force(0);
}
...
{
printf("================= JCPRINT:FixNeighlistMesh::min_setup_pre_force is being called ======\n");
    pre_neighbor();
    pre_force(0);
}
...
{
printf("================= JCPRINT:FixNeighlistMesh::pre_delete is being called ======\n");
    if(unfixflag)
...
{
printf("================= JCPRINT:FixNeighlistMesh::setmask is being called ======\n");
    int mask = 0;
...
{
printf("================= JCPRINT:FixNeighlistMesh::pre_neighbor is being called ======\n");
    buildNeighList = true;
}
...
{
printf("================= JCPRINT:FixNeighlistMesh::min_pre_force is being called ======\n");
    pre_force(vflag);
}
...
{
printf("================= JCPRINT:FixNeighlistMesh::pre_force is being called ======\n");
...
{
printf("================= JCPRINT:FixNeighlistMesh::checkBin is being called ======\n");
...
{
printf("================= JCPRINT:FixNeighlistMesh::handleTriangle is being called ======\n");
    TriangleNeighlist & triangle = triangles[iTri];
...
{
printf("================= JCPRINT:FixNeighlistMesh::getBinBoundariesFromBoundingBox is being called ======\n");
...
{
printf("================= JCPRINT:FixNeighlistMesh::getBinBoundariesForTriangle is being called ======\n");
...
{
printf("================= JCPRINT:FixNeighlistMesh::post_run is being called ======\n");
...
{
printf("================= JCPRINT:FixNeighlistMesh::generate_bin_list is being called ======\n");
...
{
printf("================= JCPRINT:FixNeighlistMesh::getSizeNumContacts is being called ======\n");
