...
{
printf("================= JCPRINT:Universe::reorder is being called ======\n");        
  char line[MAXLINE];
...
{
printf("================= JCPRINT:Universe::add_world is being called ======\n");        
  int n,nper;
  char *ptr;
...
{
printf("================= JCPRINT:Universe::consistent is being called ======\n");        
  int n = 0;
...
{
printf("================= JCPRINT:Universe::id is being called ======\n");        
