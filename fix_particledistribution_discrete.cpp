...
fprintf(screen,"Fix_particleditribution_discrete is being used \n");
}
...
{
printf("================= JCPRINT:FixParticledistributionDiscrete::setmask is being called ======\n");    
    int mask = 0;
    return mask;
}
...
{
printf("================= JCPRINT:FixParticledistributionDiscrete::random_init_single is being called ======\n");    
    ninsert = ntotal;
    ninserted = 0;
...
{
printf("================= JCPRINT:FixParticledistributionDiscrete::randomize_single is being called ======\n");    
    if(ntemplates == 1){
...
{
printf("================= JCPRINT:FixParticledistributionDiscrete::random_init_list is being called ======\n");    
...
{
printf("================= JCPRINT:FixParticledistributionDiscrete::direct_init_list is being called ======\n");    
...
{
printf("================= JCPRINT:FixParticledistributionDiscrete::randomize_list is being called ======\n");    
    if(ntotal > n_pti_max)
    {
...
{
printf("================= JCPRINT:FixParticledistributionDiscrete::direct_set_ptlist is being called ======\n");    
...
{
printf("================= JCPRINT:FixParticledistributionDiscrete::update_ptlist_pointer is being called ======\n");    
    n_pti = 0;
    ninsert = 0;
    for (int i = 0; i < ntemplates; i++)
    {
...
{
printf("================= JCPRINT:FixParticledistributionDiscrete::pre_insert is being called ======\n");    
...
{
printf("================= JCPRINT:FixParticledistributionDiscrete::insert is being called ======\n");    
...
{
printf("================= JCPRINT:FixParticledistributionDiscrete::finalize_insertion is being called ======\n");    
    for(int i = 0; i < ntemplates; i++)
...
{
printf("================= JCPRINT:FixParticledistributionDiscrete::vol_expect is being called ======\n");    
    return volexpect;
}
...
{
printf("================= JCPRINT:FixParticledistributionDiscrete::mass_expect is being called ======\n");    
    return massexpect;
}
...
{
printf("================= JCPRINT:FixParticledistributionDiscrete::min_rad is being called ======\n");    
    //get minrad
...
{
printf("================= JCPRINT:FixParticledistributionDiscrete::max_rad is being called ======\n");    
    //get maxrad
...
{
printf("================= JCPRINT:FixParticledistributionDiscrete::max_type is being called ======\n");    
    return maxtype;
}
...
{
printf("================= JCPRINT:FixParticledistributionDiscrete::min_type is being called ======\n");    
    return mintype;
}
...
{
printf("================= JCPRINT:FixParticledistributionDiscrete::max_nspheres is being called ======\n");    
    return maxnspheres;
}
...
{
printf("================= JCPRINT:FixParticledistributionDiscrete::write_restart is being called ======\n");    
  int n = 0;
  double list[1];
...
{
printf("================= JCPRINT:FixParticledistributionDiscrete::restart is being called ======\n");    
  int n = 0;
...
{
printf("================= JCPRINT:FixParticledistributionDiscrete::generate_hash is being called ======\n");    
    unsigned int hash = 0;
...
{
printf("================= JCPRINT:FixParticledistributionDiscrete::add_hash_value1 is being called ======\n");    
    if (value >= 0)
...
{
printf("================= JCPRINT:FixParticledistributionDiscrete::add_hash_value2 is being called ======\n");    
    int ivalue = 0;
    if (value < 0)
        value *= -1.0;
    if (value > 1e-50)
