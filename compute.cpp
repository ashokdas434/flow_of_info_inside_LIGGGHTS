...
fprintf(screen,"compute is being used \n");
}
...
{
printf("================= JCPRINT:Compute::modify_params is being called ======\n");
...
{
printf("================= JCPRINT:Compute::reset_extra_dof is being called ======\n");
  extra_dof = domain->dimension;
}
...
{
printf("================= JCPRINT:Compute::reset_extra_compute_fix is being called ======\n");
  error->all(FLERR,
...
{
printf("================= JCPRINT:Compute::addstep is being called ======\n");
...
{
printf("================= JCPRINT:Compute::matchstep is being called ======\n");
...
{
printf("================= JCPRINT:Compute::clearstep is being called ======\n");
  ntime = 0;
}
...
{
printf("================= JCPRINT:Compute::molecules_in_group is being called ======\n");
  int i;
