...
{
fprintf(screen,"property_registry is being used \n");
}
...
{
printf("================= JCPRINT:PropertyRegistry::max_type is being called ======\n");
  return properties.max_type();
}

double PropertyRegistry::min_radius()
{
printf("================= JCPRINT:PropertyRegistry::min_radius is being called ======\n");
  return properties.min_radius();
}

double PropertyRegistry::max_radius()
{
printf("================= JCPRINT:PropertyRegistry::max_radius is being called ======\n");
  return properties.max_radius();
}

LAMMPS * PropertyRegistry::getLAMMPS()
{
printf("================= JCPRINT:PropertyRegistry::getLAMMPS is being called ======\n");
  return lmp;
}
...
{
printf("================= JCPRINT:PropertyRegistry::getGlobalProperty is being called ======\n");
...
{
printf("================= JCPRINT:PropertyRegistry::getScalarProperty is being called ======\n");
...
{
printf("================= JCPRINT:PropertyRegistry::getVectorProperty is being called ======\n");
...
{
printf("================= JCPRINT:PropertyRegistry::getMatrixProperty is being called ======\n");
...
{
printf("================= JCPRINT:PropertyRegistry::registerProperty is being called ======\n");
  if(scalar_creators.find(varname) == scalar_creators.end()) {
...
{
printf("================= JCPRINT:PropertyRegistry::registerProperty1 is being called ======\n");
  if(vector_creators.find(varname) == vector_creators.end()) {
...
{
printf("================= JCPRINT:PropertyRegistry::registerProperty2 is being called ======\n");
  if(matrix_creators.find(varname) == matrix_creators.end()) {
...
{
printf("================= JCPRINT:PropertyRegistry::connect is being called ======\n");
  if(matrices.find(varname) == matrices.end()) {
    if(matrix_creators.find(varname) != matrix_creators.end()) {
      matrices[varname] = (*matrix_creators[varname])(*this, caller, use_sanity_checks[varname]);
    } else {
...
void PropertyRegistry::connect(string varname, double * & variable, const char *caller)
{
printf("================= JCPRINT:PropertyRegistry::connect1 is being called ======\n");
  if(vectors.find(varname) == vectors.end()) {
    if(vector_creators.find(varname) != vector_creators.end()) {
      vectors[varname] = (*vector_creators[varname])(*this, caller, use_sanity_checks[varname]);
    } else {
...
void PropertyRegistry::connect(string varname, double & variable, const char *caller)
{
printf("================= JCPRINT:PropertyRegistry::connect2 is being called ======\n");
  if(scalars.find(varname) == scalars.end()) {
    if(scalar_creators.find(varname) != scalar_creators.end()) {
      scalars[varname] = (*scalar_creators[varname])(*this, caller, use_sanity_checks[varname]);
    } else {
...
{
printf("================= JCPRINT:PropertyRegistry::init is being called ======\n");
...
{
printf("================= JCPRINT:PropertyRegistry::print_all is being called ======\n");
  for(std::map<string,ScalarProperty*>::iterator it = scalars.begin(); it != scalars.end(); ++it) {
