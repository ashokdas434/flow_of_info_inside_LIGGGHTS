...
fprintf(screen,"dump_particle is being used \n");
}
...
{
printf("====== JCPRINTS: DumpParticle :: parse_parameters is being called\n");
...
{
printf("====== JCPRINTS: DumpParticle :: init_style  is being called\n");
...
{
printf("====== JCPRINTS: DumpParticle :: count is being called\n");
    n_calls_ = 0;
...
{
printf("====== JCPRINTS: DumpParticle :: prepare_mbSet is being called\n");
...
{
printf("====== JCPRINTS: DumpParticle :: pack is being called\n");
    int n = 0;
...
{
printf("====== JCPRINTS: DumpParticle :: buf2arrays is being called\n");
    int ntri_max = 0;
#ifdef CONVEX_ACTIVE_FLAG
    if (convex_hull_detected)
...
{
printf("====== JCPRINTS: DumpParticle :: prepare_domain_data is being called\n");
...
{
printf("====== JCPRINTS: DumpParticle ::prepare_domain_data_triclinic  is being called\n");
...
{
printf("====== JCPRINTS: DumpParticle :: write_data  is being called\n");
    ++n_calls_;
...
{
printf("====== JCPRINTS: DumpParticle :: reset_vtk_data_containers is being called\n");
...
{
printf("====== JCPRINTS: DumpParticle ::identify_vectors  is being called\n");
    // detect vectors
...
{
printf("====== JCPRINTS: DumpParticle :: identify_tensor is being called\n");
...
{
printf("====== JCPRINTS: DumpParticle :: add_compute is being called\n");
    int icompute;
...
{
printf("====== JCPRINTS: DumpParticle ::add_fix  is being called\n");
    int ifix;
...
{
printf("====== JCPRINTS: DumpParticle ::add_variable  is being called\n");
    int ivariable;
...
{
printf("====== JCPRINTS: DumpParticle :: modify_param  is being called\n");
...
{
printf("====== JCPRINTS: DumpParticle :: memory_usage is being called\n");
    int bytes = 0;
...
{
printf("====== JCPRINTS: DumpParticle :: pack_compute is being called\n");
...
{
printf("====== JCPRINTS: DumpParticle :: pack_fix is being called\n");
...
{
printf("====== JCPRINTS: DumpParticle :: pack_variable is being called\n");
...
{
printf("====== JCPRINTS: DumpParticle :: pack_id is being called\n");
    int *tag = atom->tag;
...
{
printf("====== JCPRINTS: DumpParticle ::pack_molecule  is being called\n");
    int *molecule = atom->molecule;
...
{
printf("====== JCPRINTS: DumpParticle ::pack_type  is being called\n");
    int *type = atom->type;
...
{
printf("====== JCPRINTS: DumpParticle ::pack_mass  is being called\n");
    int *type = atom->type;
    double *mass = atom->mass;
...
{
printf("====== JCPRINTS: DumpParticle ::pack_x  is being called\n");
    double **x = atom->x;
...
{
printf("====== JCPRINTS: DumpParticle :: pack_y is being called\n");
    double **x = atom->x;
...
{
printf("====== JCPRINTS: DumpParticle ::pack_z  is being called\n");
    double **x = atom->x;
...
{
printf("====== JCPRINTS: DumpParticle :: pack_points_convexhull is being called\n");
#ifdef CONVEX_ACTIVE_FLAG
...
{
printf("====== JCPRINTS: DumpParticle ::pack_xs  is being called\n");
    double **x = atom->x;
...
{
printf("====== JCPRINTS: DumpParticle ::pack_ys  is being called\n");
    double **x = atom->x;
...
{
printf("====== JCPRINTS: DumpParticle ::pack_zs  is being called\n");
    double **x = atom->x;
...
{
printf("====== JCPRINTS: DumpParticle ::pack_xs_triclinic  is being called\n");
    int j;
    double **x = atom->x;
...
{
printf("====== JCPRINTS: DumpParticle ::pack_ys_triclinic  is being called\n");
    int j;
    double **x = atom->x;
...
{
printf("====== JCPRINTS: DumpParticle :: pack_zs_triclinic is being called\n");
    double **x = atom->x;
...
{
printf("====== JCPRINTS: DumpParticle :: pack_xu  is being called\n");
    int j;
    double **x = atom->x;
    tagint *image = atom->image;
...
{
printf("====== JCPRINTS: DumpParticle :: pack_yu is being called\n");
    int j;
    double **x = atom->x;
    tagint *image = atom->image;
...
{
printf("====== JCPRINTS: DumpParticle :: pack_zu is being called\n");
    int j;
    double **x = atom->x;
    tagint *image = atom->image;
...
{
printf("====== JCPRINTS: DumpParticle :: pack_xu_triclinic  is being called\n");
    int j;
    double **x = atom->x;
    tagint *image = atom->image;
...
{
printf("====== JCPRINTS: DumpParticle :: pack_yu_triclinic is being called\n");
    int j;
    double **x = atom->x;
    tagint *image = atom->image;
...
{
printf("====== JCPRINTS: DumpParticle :: pack_zu_triclinic is being called\n");
    int j;
    double **x = atom->x;
    tagint *image = atom->image;
...
{
printf("====== JCPRINTS: DumpParticle :: pack_xsu  is being called\n");
    int j;
    double **x = atom->x;
    tagint *image = atom->image;
...
{
printf("====== JCPRINTS: DumpParticle :: pack_ysu  is being called\n");
    int j;
    double **x = atom->x;
    tagint *image = atom->image;
...
{
printf("====== JCPRINTS: DumpParticle :: pack_zsu  is being called\n");
    int j;
    double **x = atom->x;
    tagint *image = atom->image;
...
{
printf("====== JCPRINTS: DumpParticle :: pack_xsu_triclinic is being called\n");
    int j;
    double **x = atom->x;
    tagint *image = atom->image;
...
{
printf("====== JCPRINTS: DumpParticle ::pack_ysu_triclinic  is being called\n");
    int j;
    double **x = atom->x;
    tagint *image = atom->image;
...
{
printf("====== JCPRINTS: DumpParticle :: pack_zsu_triclinic is being called\n");
    int j;
    double **x = atom->x;
    tagint *image = atom->image;
...
{
printf("====== JCPRINTS: DumpParticle :: pack_ix is being called\n");
    tagint *image = atom->image;
...
{
printf("====== JCPRINTS: DumpParticle :: pack_iy is being called\n");
    tagint *image = atom->image;
...
{
printf("====== JCPRINTS: DumpParticle :: pack_iz is being called\n");
    tagint *image = atom->image;
...
{
printf("====== JCPRINTS: DumpParticle ::pack_vx  is being called\n");
    double **v = atom->v;
...
{
printf("====== JCPRINTS: DumpParticle :: pack_vy  is being called\n");
    double **v = atom->v;
...
{
printf("====== JCPRINTS: DumpParticle ::pack_vz  is being called\n");
    double **v = atom->v;
...
{
printf("====== JCPRINTS: DumpParticle :: pack_fx is being called\n");
    double **f = atom->f;
...
{
printf("====== JCPRINTS: DumpParticle :: pack_fy is being called\n");
    double **f = atom->f;
...
{
printf("====== JCPRINTS: DumpParticle :: pack_fz  is being called\n");
    double **f = atom->f;
...
{
printf("====== JCPRINTS: DumpParticle :: pack_q  is being called\n");
    double *q = atom->q;
...
{
printf("====== JCPRINTS: DumpParticle :: pack_density is being called\n");
...
{
printf("====== JCPRINTS: DumpParticle :: pack_p  is being called\n");
    double *p = atom->p;
...
{
printf("====== JCPRINTS: DumpParticle :: pack_rho  is being called\n");
    double *rho = atom->rho;
...
{
printf("====== JCPRINTS: DumpParticle :: pack_mux is being called\n");
    double **mu = atom->mu;
...
{
printf("====== JCPRINTS: DumpParticle :: pack_muy  is being called\n");
    double **mu = atom->mu;
...
{
printf("====== JCPRINTS: DumpParticle :: pack_muz is being called\n");
    double **mu = atom->mu;
...
{
printf("====== JCPRINTS: DumpParticle ::pack_mu  is being called\n");
    double **mu = atom->mu;
...
{
printf("====== JCPRINTS: DumpParticle :: pack_radius is being called\n");
    double *radius = atom->radius;
...
{
printf("====== JCPRINTS: DumpParticle :: pack_diameter is being called\n");
    double *radius = atom->radius;
...
{
printf("====== JCPRINTS: DumpParticle :: pack_omegax  is being called\n");
...
{
printf("====== JCPRINTS: DumpParticle :: pack_omegay is being called\n");
    double **omega = atom->omega;
...
{
printf("====== JCPRINTS: DumpParticle ::pack_omegaz  is being called\n");
    double **omega = atom->omega;
...
{
printf("====== JCPRINTS: DumpParticle ::pack_angmomx  is being called\n");
...
{
printf("====== JCPRINTS: DumpParticle ::pack_angmomy is being called\n");
    double **angmom = atom->angmom;
...
{
printf("====== JCPRINTS: DumpParticle ::pack_angmomz  is being called\n");
    double **angmom = atom->angmom;
...
{
printf("====== JCPRINTS: DumpParticle ::pack_tqx  is being called\n");
...
{
printf("====== JCPRINTS: DumpParticle ::pack_tqy  is being called\n");
    double **torque = atom->torque;
...
{
printf("====== JCPRINTS: DumpParticle ::pack_tqz  is being called\n");
    double **torque = atom->torque;
...
{
printf("====== JCPRINTS: DumpParticle ::pack_spin  is being called\n");
    int *spin = atom->spin;
...
{
printf("====== JCPRINTS: DumpParticle :: pack_eradius is being called\n");
...
{
printf("====== JCPRINTS: DumpParticle :: pack_ervel is being called\n");
...
{
printf("====== JCPRINTS: DumpParticle :: pack_erforce is being called\n");
...
{
printf("====== JCPRINTS: DumpParticle :: pack_shapex is being called\n");
...
{
printf("====== JCPRINTS: DumpParticle ::pack_shapey  is being called\n");
    double **shape = atom->shape;
...
{
printf("====== JCPRINTS: DumpParticle ::pack_shapez  is being called\n");
    double **shape = atom->shape;
...
{
printf("====== JCPRINTS: DumpParticle ::pack_blockiness1  is being called\n");
...
{
printf("====== JCPRINTS: DumpParticle :: pack_blockiness2 is being called\n");
    double **blockiness = atom->blockiness;
...
{
printf("====== JCPRINTS: DumpParticle :: pack_tensor is being called\n");
    double **quaternion = atom->quaternion;
    for (int i = 0; i < nchoose; i++) {
        double mat[3][3];
...
{
printf("====== JCPRINTS: DumpParticle ::pack_quat1  is being called\n");
    double **quaternion = atom->quaternion;
    for (int i = 0; i < nchoose; i++) {
...
{
printf("====== JCPRINTS: DumpParticle :: pack_quat2 is being called\n");
    double **quaternion = atom->quaternion;
    for (int i = 0; i < nchoose; i++) {
...
{
printf("====== JCPRINTS: DumpParticle ::pack_quat3  is being called\n");
    double **quaternion = atom->quaternion;
    for (int i = 0; i < nchoose; i++) {
...
{
printf("====== JCPRINTS: DumpParticle ::pack_quat4  is being called\n");
    double **quaternion = atom->quaternion;
    for (int i = 0; i < nchoose; i++) {
