...
fprintf(screen,"Fix_template_sphere is being used \n");
}
...
{
printf("================= JCPRINT:FixTemplateSphere::setmask is being called ======\n");    
  int mask = 0;
  return mask;
}
...
{
printf("================= JCPRINT:FixTemplateSphere::region is being called ======\n");    
...
{
printf("================= JCPRINT:FixTemplateSphere::randomize_single is being called ======\n");    
...
{
printf("================= JCPRINT:FixTemplateSphere::init_ptilist is being called ======\n");    
...
{
printf("================= JCPRINT:FixTemplateSphere::delete_ptilist is being called ======\n");    
...
{
printf("================= JCPRINT:FixTemplateSphere::randomize_ptilist is being called ======\n");    
...
{
printf("================= JCPRINT:FixTemplateSphere::direct_set_ptlist is being called ======\n");    
...
{
printf("================= JCPRINT:FixTemplateSphere::min_rad is being called ======\n");        
...
{
printf("================= JCPRINT:FixTemplateSphere::max_rad is being called ======\n");        
...
{
printf("================= JCPRINT:FixTemplateSphere::max_r_bound is being called ======\n");        
    return pdf_max(pdf_radius);
}
...
{
printf("================= JCPRINT:FixTemplateSphere::volexpect is being called ======\n");        
...
{
printf("================= JCPRINT:FixTemplateSphere::massexpect is being called ======\n");        
    return mass_expect;
}
...
{
printf("================= JCPRINT:FixTemplateSphere::number_spheres is being called ======\n");        
    return 1;
}
...
{
printf("================= JCPRINT:FixTemplateSphere::maxtype is being called ======\n");        
    return atom_type;
}
...
{
printf("================= JCPRINT:FixTemplateSphere::mintype is being called ======\n");        
    return atom_type;
}
...
{
printf("================= JCPRINT:FixTemplateSphere::write_restart is being called ======\n");        
  int n = 0;
...
{
printf("================= JCPRINT:FixTemplateSphere::restart is being called ======\n");        
...
{
printf("================= JCPRINT:FixTemplateSphere::generate_hash is being called ======\n");        
    unsigned int hash = 0;
...
{
printf("================= JCPRINT:FixTemplateSphere::add_hash_value1 is being called ======\n");        
    if (value >= 0)
...
{
printf("================= JCPRINT:FixTemplateSphere::add_hash_value2 is being called ======\n");        
    int ivalue = 0;
    if (value < 0)
        value *= -1.0;
    if (value > 1e-50)
