...
fprintf(screen,"integrate is being used \n");
}
...
void Integrate::init()
{
printf("================= JCPRINT:Integrate::init is being called ======\n");
...
{
printf("================= JCPRINT:Integrate::ev_setup is being called ======\n");
  delete [] elist_global;
  delete [] elist_atom;
  delete [] vlist_global;
  delete [] vlist_atom;
...
{
printf("================= JCPRINT:Integrate::ev_set is being called ======\n");
  int i,flag;
