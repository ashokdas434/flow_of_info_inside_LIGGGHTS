...
FixBaseLiggghts::FixBaseLiggghts(LAMMPS *lmp, int narg, char **arg) : Fix(lmp, narg, arg),
  ...
  iregion_(-1)
{
fprintf(screen,"Fix_base_liggghts is being used \n");
}
...
{
printf("=================JCPRINT:FixBaseLiggghts::process_region is being called  ======\n");
...
{
printf("=================JCPRINT:FixBaseLiggghts::init is being called  ======\n");
    // error checks
...
{
printf("=================JCPRINT:FixBaseLiggghts::setup is being called  ======\n");
...
{
printf("=================JCPRINT:FixBaseLiggghts::count_eligible is being called  ======\n");
