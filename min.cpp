...
fprintf(screen,"min is being used \n");
}
...
void Min::init()
{
printf("================= JCPRINT:Min::init is being called ======\n");
...
void Min::setup()
{
printf("================= JCPRINT:Min::setup is being called ======\n");
...
{
printf("================= JCPRINT:Min::setup_minimal is being called ======\n");
  update->setupflag = 1;
...
void Min::run(int n)
{
printf("================= JCPRINT:Min::run is being called ======\n");
  ...
  if (stop_condition) {
    ...
    if (update->restrict_output == 0) {
      ...
      output->request_restart(update->ntimestep);
    }
...
void Min::cleanup()
{
printf("================= JCPRINT:Min::cleanup is being called ======\n");
  // stats for Finish to print
...
{
printf("================= JCPRINT:Min::energy_force is being called ======\n");
...
{
printf("================= JCPRINT:Min::force_clear is being called ======\n");
...
{
printf("================= JCPRINT:Min::request is being called ======\n");
  int n = nextra_atom + 1;
...
{
printf("================= JCPRINT:Min::modify_params is being called ======\n");
...
void Min::ev_setup()
{
printf("================= JCPRINT:Min::ev_setup1 is being called ======\n");
  delete [] elist_global;
  delete [] elist_atom;
  delete [] vlist_global;
  delete [] vlist_atom;
...
{
printf("================= JCPRINT:Min::ev_setup2 called ======\n");
  int i,flag;
...
{
printf("================= JCPRINT:Min::fnorm_sqr is being called ======\n");
  int i,n;
  double *fatom;
...
{
printf("================= JCPRINT:Min::fnorm_inf is being called ======\n");
  int i,n;
  double *fatom;
...
{
printf("================= JCPRINT:Min::stopstrings is being called ======\n");
