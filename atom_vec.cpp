...
AtomVec::AtomVec(LAMMPS *lmp) : Pointers(lmp)
{
  ...
  size_data_bonus = 0;
  cudable = false;
fprintf(screen,"atom_vec is being used \n");
}
...
{
printf("================= JCPRINT: AtomVec::settings is being called ======\n");
...
void AtomVec::init()
{
printf("================= JCPRINT: AtomVec::init is being called ======\n");
...
{
printf("================= JCPRINT: AtomVec::grow_nmax is being called ======\n");
...
{
printf("================= JCPRINT:AtomVec::grow_nmax_bonus is being called ======\n");
...
{
printf("================= JCPRINT: AtomVec::data_vel  is being called ======\n");
  double **v = atom->v;
  v[m][0] = atof(values[0]);
  v[m][1] = atof(values[1]);
  v[m][2] = atof(values[2]);
...
{
printf("================= JCPRINT: AtomVec::pack_vel is being called ======\n");
  double **v = atom->v;
  int *tag = atom->tag;
...
{
printf("================= JCPRINT: AtomVec::write_vel  is being called ======\n");
  for (int i = 0; i < n; i++)
...
{
printf("================= JCPRINT: AtomVec::pack_bond is being called ======\n");
  int *tag = atom->tag;
...
{
printf("================= JCPRINT:AtomVec::write_bond is being called ======\n");
  for (int i = 0; i < n; i++) {
...
{
printf("================= JCPRINT:AtomVec::pack_angle  is being called ======\n");
  int *tag = atom->tag;
...
{
printf("================= JCPRINT: AtomVec::write_angle  is being called ======\n");
  for (int i = 0; i < n; i++) {
...
{
printf("================= JCPRINT:AtomVec::pack_dihedral  is being called ======\n");
  int *tag = atom->tag;
...
{
printf("================= JCPRINT: AtomVec::write_dihedral is being called ======\n");
  for (int i = 0; i < n; i++) {
...
{
printf("================= JCPRINT: AtomVec::pack_improper is being called ======\n");
  int *tag = atom->tag;
...
{
printf("================= JCPRINT:AtomVec::write_improper  is being called ======\n");
  for (int i = 0; i < n; i++) {
    fprintf(fp,"%d %d %d %d %d %d\n",index,
            buf[i][0],buf[i][1],buf[i][2],buf[i][3],buf[i][4]);
    index++;
