...
fprintf(screen,"update is being used \n");
}
...
void Update::init()
{
printf("================= JCPRINT:Update::init is being called ======\n");
...
{
printf("================= JCPRINT:Update::set_units is being called ======\n");
...
{
printf("================= JCPRINT:Update::create_integrate is being called ======\n");
...
{
printf("================= JCPRINT:Update::new_integrate is being called ======\n");
  int success = 0;
...
{
printf("================= JCPRINT:Update::create_minimize is being called ======\n");
...
{
printf("================= JCPRINT:Update::reset_timestep1 is being called ======\n");
...
{
 printf("================= JCPRINT:Update::reset_timestep2 is being called ======\n");
...
{
printf("================= JCPRINT:Update::update_time is being called ======\n");
  atime += (ntimestep-atimestep) * dt;
  atimestep = ntimestep;
}
...
{
printf("================= JCPRINT:Update::memory_usage is being called ======\n");
  bigint bytes = 0;
