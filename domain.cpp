    ...
    is_wedge(false)
{
    ...
    set_lattice(2,args);
    delete [] args;
fprintf(screen,"domain is being used \n");
}
...
void Domain::init()
{
printf("=================JCPRINT: Domain::init is being called  ======\n");
...
{
printf("=================JCPRINT: Domain::set_initial-box is being called  ======\n");
...
{
printf("=================JCPRINT: Domain::set_global_box is being called  ======\n");
...
{
printf("=================JCPRINT: Domain::set_lamda_box is being called  ======\n");
...
{
printf("=================JCPRINT: Domain::set_local_box is being called  ======\n");
  int *myloc = comm->myloc;
...
{
printf("=================JCPRINT: Domain::reset_box is being called  ======\n");
...
void Domain::pbc()
{
printf("=================JCPRINT: Domain::pbc is being called  ======\n");
  int i;
...
{
printf("=================JCPRINT: Domain::image_check is being called  ======\n");
  int i,j,k;
...
{
printf("=================JCPRINT: Domain::box_too_small_check is being called  ======\n");
  int i,j,k;
...
{
printf("=================JCPRINT: Domain::minimum_image is being called  ======\n");
  if (triclinic == 0) {
    if (xperiodic) {
...
{
printf("=================JCPRINT: Domain::closest_image is being called  ======\n");
  if (j < 0) return j;
...
{
printf("=================JCPRINT: Domain::remap is being called  ======\n");
...
{
printf("=================JCPRINT: Domain::remap_near is being called  ======\n");
  int n;
...
{
printf("=================JCPRINT: Domain::unmap is being called  ======\n");
...
{
printf("=================JCPRINT: Domain::image_flip is being called  ======\n");
  tagint *image = atom->image;
  int nlocal = atom->nlocal;
...
{
printf("=================JCPRINT: Domain::set_lattice is being called  ======\n");
...
{
printf("=================JCPRINT: Domain::add_region is being called  ======\n");
...
{
printf("=================JCPRINT: Domain::delete_region is being called  ======\n");
  if (narg != 2) error->all(FLERR,"Illegal region command");
...
{
printf("=================JCPRINT: Domain::find_region is being called  ======\n");
...
{
printf("=================JCPRINT: Domain::set_boundary is being called  ======\n");
...
{
printf("=================JCPRINT: Domain::set_box is being called  ======\n");
...
{
printf("=================JCPRINT: Domain::print_box is being called  ======\n");
  if (comm->me == 0) {
    if (screen) {
      if (triclinic == 0)
...
{
printf("=================JCPRINT: Domain::boundary_string is being called  ======\n");
  int m = 0;
  for (int idim = 0; idim < 3; idim++) {
    for (int iside = 0; iside < 2; iside++) {
...
{
printf("=================JCPRINT: Domain::lambda2x is being called  ======\n");
  double **x = atom->x;
...
{
printf("=================JCPRINT: Domain::xtolambda is being called  ======\n");
  double delta[3];
  double **x = atom->x;
...
{
printf("=================JCPRINT: Domain:: x2lambda is being called  ======\n");
  double delta[3];
  delta[0] = x[0] - boxlo[0];
  delta[1] = x[1] - boxlo[1];
  delta[2] = x[2] - boxlo[2];
...
{
printf("=================JCPRINT: Domain::bbox is being called  ======\n");
  double x[3];
...
{
printf("=================JCPRINT: Domain::box_corners is being called  ======\n");
