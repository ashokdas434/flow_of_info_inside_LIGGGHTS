  ...
  fix_ms_(NULL)
{
  ...
  strcpy(names[0],str);
  ngroup = 1;
fprintf(screen,"group is being used \n");
}
...
{
printf("================= JCPRINT:Group::assign is being called ======\n");
  int i;
...
{
printf("================= JCPRINT:Group::create is being called ======\n");
  int i;
...
void Group::init()
{
printf("================= JCPRINT:Group::init is being called ======\n");
...
{
printf("================= JCPRINT:Group::set is being called ======\n");
  int igroup = find(name);
...
{
printf("================= JCPRINT:Group::find is being called ======\n");
...
{
printf("================= JCPRINT:Group::find_unused is being called ======\n");
  for (int igroup = 0; igroup < MAX_GROUP; igroup++)
...
{
printf("================= JCPRINT:Group::write_restart is being called ======\n");
...
{
printf("================= JCPRINT:Group::read_restart is being called ======\n");
  int i,n;
...
{
printf("================= JCPRINT:Group::count1 is being called ======\n");
...
{
printf("================= JCPRINT:Group::count2 is being called ======\n");
  int groupbit = bitmask[igroup];
...
{
printf("================= JCPRINT:Group::count_ms1 is being called ======\n");
  int groupbit = bitmask[igroup];
...
{
printf("================= JCPRINT:Group::count_ms2 is being called ======\n");
  int groupbit = bitmask[igroup];
  Region *region = domain->regions[iregion];
...
{
printf("================= JCPRINT:Group::mass1 is being called ======\n");
  int groupbit = bitmask[igroup];
...
{
printf("================= JCPRINT:Group::mass2 is being called ======\n");
  int groupbit = bitmask[igroup];
  Region *region = domain->regions[iregion];
...
{
printf("================= JCPRINT:Group::charge1 is being called ======\n");
  int groupbit = bitmask[igroup];
...
{
printf("================= JCPRINT:Group::charge2 is being called ======\n");
  int groupbit = bitmask[igroup];
  Region *region = domain->regions[iregion];
...
{
printf("================= JCPRINT:Group::bounds1 is being called ======\n");
  int groupbit = bitmask[igroup];
...
{
printf("================= JCPRINT:Group::bounds2 is being called ======\n");
  int groupbit = bitmask[igroup];
  Region *region = domain->regions[iregion];
...
{
printf("================= JCPRINT:Group::xcm is being called ======\n");
  int groupbit = bitmask[igroup];
...
{
printf("================= JCPRINT:Group::xcm2 is being called ======\n");
  int groupbit = bitmask[igroup];
  Region *region = domain->regions[iregion];
...
{
printf("================= JCPRINT:Group::vcm is being called ======\n");
  int groupbit = bitmask[igroup];
...
{
printf("================= JCPRINT:Group::vcm1 is being called ======\n");
  int groupbit = bitmask[igroup];
  Region *region = domain->regions[iregion];
...
{
printf("================= JCPRINT:Group::fcm is being called ======\n");
  int groupbit = bitmask[igroup];
...
{
printf("================= JCPRINT:Group::fcm1 is being called ======\n");
  int groupbit = bitmask[igroup];
  Region *region = domain->regions[iregion];
...
{
printf("================= JCPRINT:Group::ke is being called ======\n");
  int groupbit = bitmask[igroup];
...
{
printf("================= JCPRINT:Group::ke1 is being called ======\n");
  int groupbit = bitmask[igroup];
  Region *region = domain->regions[iregion];
...
{
printf("================= JCPRINT:Group::gyration is being called ======\n");
  int groupbit = bitmask[igroup];
...
{
printf("================= JCPRINT:Group::gyration1 is being called ======\n");
  int groupbit = bitmask[igroup];
  Region *region = domain->regions[iregion];
...
{
printf("================= JCPRINT:Group::angmom is being called ======\n");
  int groupbit = bitmask[igroup];
...
{
printf("================= JCPRINT:Group::angmom1 is being called ======\n");
  int groupbit = bitmask[igroup];
  Region *region = domain->regions[iregion];
...
{
printf("================= JCPRINT:Group::torque is being called ======\n");
  int groupbit = bitmask[igroup];
...
{
printf("================= JCPRINT:Group::torque1 is being called ======\n");
  int groupbit = bitmask[igroup];
  Region *region = domain->regions[iregion];
...
{
printf("================= JCPRINT:Group::inertia is being called ======\n");
  int i,j;
...
{
printf("================= JCPRINT:Group::inertia1 is being called ======\n");
  int i,j;
...
{
printf("================= JCPRINT:Group::omega is being called ======\n");
  double inverse[3][3];
