...
fprintf(screen,"thermo is being used \n");
}
...
void Thermo::init()
{
printf("================= JCPRINT:Thermo::init is being called ======\n");
  int i,n;
...
void Thermo::header()
{
printf("================= JCPRINT:Thermo::header is being called ======\n");
...
{
printf("================= JCPRINT:Thermo::compute is being called ======\n");
  int i;
...
{
printf("================= JCPRINT:Thermo::lost_check is being called ======\n");
...
{
printf("================= JCPRINT:Thermo::modify_params is being called ======\n");
...
{
printf("================= JCPRINT:Thermo::allocate is being called ======\n");
...
{
printf("================= JCPRINT:Thermo::deallocate is being called ======\n");
  int n = nfield_initial + 1;
...
{
printf("================= JCPRINT:Thermo::parse_fields is being called ======\n");
  nfield = 0;
...
{
printf("================= JCPRINT:Thermo::addfield is being called ======\n");
...
{
printf("================= JCPRINT:Thermo::add_compute is being called ======\n");
  int icompute;
...
{
printf("================= JCPRINT:Thermo::add_fix is being called ======\n");
  int n = strlen(id) + 1;
...
{
printf("================= JCPRINT:Thermo::add_variable is being called ======\n");
  int n = strlen(id) + 1;
...
{
printf("================= JCPRINT:Thermo::evaluate_keyword is being called ======\n");
  // turn off normflag if natoms = 0 to avoid divide by 0
...
{
printf("================= JCPRINT:Thermo::compute_compute is being called ======\n");
...
{
printf("================= JCPRINT:Thermo::compute_fix is being called ======\n");
  int m = field2index[ifield];
  Fix *fix = fixes[m];
...
{
printf("================= JCPRINT:Thermo::compute_variable is being called ======\n");
...
{
printf("================= JCPRINT:Thermo::compute_step is being called ======\n");
...
{
printf("================= JCPRINT:Thermo::compute_elapsed is being called ======\n");
...
{
printf("================= JCPRINT:Thermo::compute_elapsed_long is being called ======\n");
...
{
printf("================= JCPRINT:Thermo::compute_dt is being called ======\n");
  dvalue = update->dt;
}
...
{
printf("================= JCPRINT:Thermo::compute_time is being called ======\n");
...
{
printf("================= JCPRINT:Thermo::compute_cpu is being called ======\n");
...
{
printf("================= JCPRINT:Thermo::compute_tpcpu is being called ======\n");
  double new_cpu;
...
{
printf("================= JCPRINT:Thermo::compute_spcpu is being called ======\n");
  double new_cpu;
...
{
printf("================= JCPRINT:Thermo::compute_cu is being called ======\n");
/*
  if (firststep == 0) dvalue = 0.0;
...
{
printf("================= JCPRINT:Thermo::compute_cpuremain is being called ======\n");
  if (firststep == 0) dvalue = 0.0;
  else dvalue = timer->elapsed(TIME_LOOP) *
...
{
printf("================= JCPRINT:Thermo::compute_part is being called ======\n");
...
{
printf("================= JCPRINT:Thermo::compute_atoms is being called ======\n");
  bivalue = atom->natoms;
}
...
{
printf("================= JCPRINT:Thermo::compute_ke is being called ======\n");
...
{
printf("================= JCPRINT:Thermo::compute_erot is being called ======\n");
  dvalue = erot->scalar;
  if (normflag) dvalue /= natoms;
}
...
{
printf("================= JCPRINT:Thermo::compute_vol is being called ======\n");
...
{
printf("================= JCPRINT:Thermo::compute_density is being called ======\n");
...
{
printf("================= JCPRINT:Thermo::compute_lx is being called ======\n");
  dvalue = domain->xprd;
}
...
{
printf("================= JCPRINT:Thermo::compute_ly is being called ======\n");
  dvalue = domain->yprd;
}
...
{
printf("================= JCPRINT:Thermo::compute_lz is being called ======\n");
  dvalue = domain->zprd;
}
...
{
printf("================= JCPRINT:Thermo::compute_xlo is being called ======\n");
...
{
printf("================= JCPRINT:Thermo::compute_xhi is being called ======\n");
...
{
printf("================= JCPRINT:Thermo::compute_ylo is being called ======\n");
...
{
printf("================= JCPRINT:Thermo::compute_yhi is being called ======\n");
...
{
printf("================= JCPRINT:Thermo::compute_zlo is being called ======\n");
...
{
printf("================= JCPRINT:Thermo::compute_zhi is being called ======\n");
...
{
printf("================= JCPRINT:Thermo::compute_xy is being called ======\n");
  dvalue = domain->xy;
}
...
{
printf("================= JCPRINT:Thermo::compute_xz is being called ======\n");
  dvalue = domain->xz;
}
...
{
printf("================= JCPRINT:Thermo::compute_yz is being called ======\n");
  dvalue = domain->yz;
}
...
{
printf("================= JCPRINT:Thermo::compute_xlat is being called ======\n");
...
{
printf("================= JCPRINT:Thermo::compute_ylat is being called ======\n");
...
{
printf("================= JCPRINT:Thermo::compute_zlat is being called ======\n");
...
{
printf("================= JCPRINT:Thermo::compute_fmax is being called ======\n");
  double **f = atom->f;
...
{
printf("================= JCPRINT:Thermo::compute_fnorm is being called ======\n");
  double **f = atom->f;
  int nlocal = atom->nlocal;
...
{
printf("================= JCPRINT:Thermo::compute_cella is being called ======\n");
  dvalue = domain->xprd;
}
...
{
printf("================= JCPRINT:Thermo::compute_cellb is being called ======\n");
  if (!domain->triclinic)
    dvalue = domain->yprd;
  else {
    double* h = domain->h;
...
{
printf("================= JCPRINT:Thermo::compute_cellc is being called ======\n");
  if (!domain->triclinic)
    dvalue = domain->zprd;
  else {
    double* h = domain->h;
...
{
printf("================= JCPRINT:Thermo::compute_cellalpha is being called ======\n");
  if (!domain->triclinic)
    dvalue = 90.0;
  else {
...
{
printf("================= JCPRINT:Thermo::compute_cellbeta is being called ======\n");
  if (!domain->triclinic)
    dvalue = 90.0;
  else {
...
{
printf("================= JCPRINT:Thermo::compute_cellgamma is being called ======\n");
  if (!domain->triclinic)
    dvalue = 90.0;
  else {
