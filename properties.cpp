...
{
fprintf(screen,"properties is being used \n");
}
...
{
printf("================= JCPRINT:Properties::max_type is being called ======\n");        
...
{
printf("================= JCPRINT:Properties::min_radius is being called ======\n");        
...
{
printf("================= JCPRINT:Properties::max_radius is being called ======\n");        
  const double maxtype = max_type();
...
{
printf("================= JCPRINT:Properties::find_property is being called ======\n");        
