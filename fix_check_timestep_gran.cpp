...
fprintf(screen,"Fix_check_timestep_gran is being used \n");
}
...
{
    printf("===== JCPRINTS: FixCheckTimestepGran::init is being called\n");
  //some error checks
...
{
    printf("===== JCPRINTS: FixCheckTimestepGran::end_of_step is being called\n");
...
{
    printf("===== JCPRINTS: FixCheckTimestepGran::calc_rayleigh_hertz_estims is being called\n");
  double **v = atom->v;
...
{
    printf("===== JCPRINTS: FixCheckTimestepGran::compute_vector is being called\n");
