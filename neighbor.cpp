...
fprintf(screen,"neighbour is being used \n");
}
...
void Neighbor::init()
{
printf("================= JCPRINT:Neighbor::init is being called ======\n");
  int i,j,m,n;
...
{
printf("================= JCPRINT:Neighbor::request is being called ======\n");
...
{
printf("================= JCPRINT:Neighbor::choose_build is being called ======\n");
  PairPtr pb = NULL;
...
{
printf("================= JCPRINT:Neighbor::choose_stencil is being called ======\n");
  StencilPtr sc = NULL;
...
{
printf("================= JCPRINT:Neighbor::print_lists_of_lists is being called ======\n");
  if (comm->me == 0) {
...
int Neighbor::decide()
{
printf("================= JCPRINT:Neighbor::decide is being called ======\n");
  if (must_check) {
...
{
printf("================= JCPRINT:Neighbor::check_distance is being called ======\n");
...
{
printf("================= JCPRINT:Neighbor::build is being called ======\n");
  int i;
...
{
printf("================= JCPRINT:Neighbor::build_topology is being called ======\n");
...
{
printf("================= JCPRINT:Neighbor::build_one is being called ======\n");
...
{
printf("================= JCPRINT:Neighbor::setup_bins is being called ======\n");
...
{
printf("================= JCPRINT:Neighbor::bin_distance is being called ======\n");
...
{
printf("================= JCPRINT:Neighbor::bin_largest_distance is being called ======\n");
  double delx,dely,delz;
...
{
printf("================= JCPRINT:Neighbor::set is being called ======\n");
...
{
printf("================= JCPRINT:Neighbor::modify_params_restricted is being called ======\n");
    // set delay to 0
    delay = 0;
...
{
printf("================= JCPRINT:Neighbor::modify_params is being called ======\n");
  int iarg = 0;
  while (iarg < narg) {
...
{
printf("================= JCPRINT:Neighbor::bin_atoms is being called ======\n");
  int i,ibin;
...
{
printf("================= JCPRINT:Neighbor::coord2bin1 is being called ======\n");
  int ix,iy,iz;
...
{
printf("================= JCPRINT:Neighbor::coord2bin2 is being called ======\n");
  if (x[0] >= bboxhi[0])
    ix = static_cast<int> ((x[0]-bboxhi[0])*bininvx) + nbinx;
  else if (x[0] >= bboxlo[0]) {
    ix = static_cast<int> ((x[0]-bboxlo[0])*bininvx);
...
{
printf("================= JCPRINT:Neighbor::bin_center is being called ======\n");
...
printf("================= JCPRINT:Neighbor::exclusion is being called ======\n");
  int m;
...
{
printf("================= JCPRINT:Neighbor::memory_usage is being called ======\n");
  bigint bytes = 0;
...
{
printf("================= JCPRINT:Neighbor::exclude_setting is being called ======\n");
  return exclude;
}
...
{
printf("================= JCPRINT:Neighbor::n_neighs is being called ======\n");
