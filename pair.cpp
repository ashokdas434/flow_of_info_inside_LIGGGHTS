...
fprintf(screen,"pair is being used \n");
}
...
{
printf("================= JCPRINT:Pair::modify_params is being called ======\n");        
...
void Pair::init()
{
printf("================= JCPRINT:Pair::init is being called ======\n");        
  int i,j;
...
void Pair::reinit()
{
printf("================= JCPRINT:Pair::reinit is being called ======\n");        
...
{
printf("================= JCPRINT:Pair::init_style is being called ======\n");        
...
{
printf("================= JCPRINT:Pair::init_list is being called ======\n");        
  list = ptr;
}
...
{
printf("================= JCPRINT:Pair::init_tables is being called ======\n");        
  int masklo,maskhi;
...
{
printf("================= JCPRINT:Pair::init_tables_disp is being called ======\n");        
  int masklo,maskhi;
  double rsq; 
...
{
printf("================= JCPRINT:Pair::free_tables is being called ======\n");        
...
{
printf("================= JCPRINT:Pair::free_disp_tables is being called ======\n");        
...
{
printf("================= JCPRINT:Pair::mix_energy is being called ======\n");        
...
{
printf("================= JCPRINT:Pair::mix_distance is being called ======\n");        
  if (mix_flag == GEOMETRIC)
...
{
printf("================= JCPRINT:Pair::compute_dummy is being called ======\n");        
...
{
printf("================= JCPRINT:Pair::ev_setup is being called ======\n");        
  int i,n;
...
void Pair::ev_unset()
{
printf("================= JCPRINT:Pair::ev_unset is being called ======\n");        
  evflag = 0;
...
{
printf("================= JCPRINT:Pair::ev_tally is being called ======\n");        
...
void Pair::ev_tally_full(int i, double evdwl, double ecoul, double fpair,
                         double delx, double dely, double delz)
{
printf("================= JCPRINT:Pair::ev_tally_full is being called ======\n");        
  double v[6];
...
void Pair::ev_tally_xyz(int i, int j, int nlocal, int newton_pair,
                        ...
                        double delx, double dely, double delz)
{
printf("================= JCPRINT:Pair::ev_tally_xyz is being called ======\n");        
  double evdwlhalf,ecoulhalf,epairhalf,v[6];
...
void Pair::ev_tally_xyz_full(int i, double evdwl, double ecoul,
                             ...
                             double delx, double dely, double delz)
{
printf("================= JCPRINT:Pair::ev_tally_xyz_full is being called ======\n");        
  double evdwlhalf,ecoulhalf,epairhalf,v[6];
...
{
printf("================= JCPRINT:Pair::ev_tally3 is being called ======\n");        
...
{
printf("================= JCPRINT:Pair::ev_tally4 is being called ======\n");        
...
{
printf("================= JCPRINT:Pair::ev_tally_tip4p is being called ======\n");        
  int i; 
...
{
printf("================= JCPRINT:Pair::v_tally is being called ======\n");        
  double v[6];
...
{
printf("================= JCPRINT:Pair::v_tally2 is being called ======\n");        
  double v[6];
...
{
printf("================= JCPRINT:Pair::v_tally3 is being called ======\n");        
  double v[6];
...
void Pair::v_tally4(int i, int j, int k, int m,
                    ...
                    double *drim, double *drjm, double *drkm)
{
printf("================= JCPRINT:Pair::v_tally4 is being called ======\n");        
  double v[6];
...
{
printf("================= JCPRINT:Pair::v_tally_tensor is being called ======\n");        
  double v[6];
...
{
printf("================= JCPRINT:Pair::virial_fdotr_compute is being called ======\n");        
  double **x = atom->x;
  double **f = atom->f;
...
{
printf("================= JCPRINT:Pair::write_file is being called ======\n");        
...
{
printf("================= JCPRINT:Pair::init_bitmap is being called ======\n");        
...
{
printf("================= JCPRINT:Pair::open_potential is being called ======\n");        
  FILE *fp;
...
{
printf("================= JCPRINT:Pair::potname is being called ======\n");        
  const char *pot;
...
{
printf("================= JCPRINT:Pair::memory_usage is being called ======\n");        
