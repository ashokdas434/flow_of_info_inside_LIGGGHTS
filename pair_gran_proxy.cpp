...
{
fprintf(screen,"pair_gran_proxy is being used \n");
}
...
{
printf("================= JCPRINT:PairGranProxy::settings is being called ======\n");
  delete impl;
...
{
printf("================= JCPRINT:PairGranProxy::init_granular is being called ======\n");
  impl->init_granular();
}

void PairGranProxy::write_restart_settings(FILE * fp)
{
printf("================= JCPRINT:PairGranProxy::write_restart_settings is being called ======\n");
  impl->write_restart_settings(fp);
}

void PairGranProxy::read_restart_settings(FILE * fp, const int major, const int minor)
{
printf("================= JCPRINT:PairGranProxy::read_restart_settings is being called ======\n");
  int me = comm->me;
...
{
printf("================= JCPRINT:PairGranProxy::compute_force is being called ======\n");
  impl->compute_force(this, eflag, vflag, addflag);
}

double PairGranProxy::stressStrainExponent()
{
printf("================= JCPRINT:PairGranProxy::stressStrainExponent is being called ======\n");
