...
AtomVecAtomic::AtomVecAtomic(LAMMPS *lmp) : AtomVec(lmp)
{
  ...
  size_data_vel = 4;
  xcol_data = 3;
fprintf(screen,"atom_vec_atomic is being used \n");
}
...
{
printf("================= JCPRINT:AtomVecAtomic::grow is being called ======\n");
  if (n == 0) nmax += DELTA;
  else nmax = n;
  atom->nmax = nmax;
...
{
printf("================= JCPRINT:AtomVecAtomic::grow_reset is being called ======\n");
...
{
printf("================= JCPRINT:AtomVecAtomic::copy is being called ======\n");
  tag[j] = tag[i];
  type[j] = type[i];
  mask[j] = mask[i];
  image[j] = image[i];
...
{
printf("================= JCPRINT:AtomVecAtomic::pack_comm is being called ======\n");
  int i,j,m;
  double dx,dy,dz;
...
int AtomVecAtomic::pack_comm_vel(int n, int *list, double *buf,
                                 int pbc_flag, int *pbc)
{
printf("================= JCPRINT:AtomVecAtomic::pack_comm_vel is being called ======\n");
  int i,j,m;
...
{
printf("================= JCPRINT:AtomVecAtomic::unpack_comm is being called ======\n");
  int i,m,last;
...
{
printf("================= JCPRINT:AtomVecAtomic::unpack_comm_vel is being called ======\n");
  int i,m,last;
...
{
printf("================= JCPRINT:AtomVecAtomic::pack_reverse is being called ======\n");
  int i,m,last;
...
{
printf("================= JCPRINT:AtomVecAtomic::unpack_reverse is being called ======\n");
  int i,j,m;
...
int AtomVecAtomic::pack_border(int n, int *list, double *buf,
                               int pbc_flag, int *pbc)
{
printf("================= JCPRINT:AtomVecAtomic::pack_border is being called ======\n");
  int i,j,m;
  double dx,dy,dz;
...
int AtomVecAtomic::pack_border_vel(int n, int *list, double *buf,
                                   int pbc_flag, int *pbc)
{
printf("================= JCPRINT:AtomVecAtomic::pack_border_vel is being called ======\n");
  int i,j,m;
  double dx,dy,dz,dvx,dvy,dvz;
...
{
printf("================= JCPRINT:AtomVecAtomic::unpack_border is being called ======\n");
  int i,m,last;
...
{
printf("================= JCPRINT:AtomVecAtomic::unpack_border_vel is being called ======\n");
  int i,m,last;
...
{
printf("================= JCPRINT:AtomVecAtomic::pack_exchange is being called ======\n");
  int m = 1;
  buf[m++] = x[i][0];
  buf[m++] = x[i][1];
  buf[m++] = x[i][2];
...
{
printf("================= JCPRINT:AtomVecAtomic::unpack_exchange is being called ======\n");
...
{
printf("================= JCPRINT:AtomVecAtomic::size_restart is being called ======\n");
  int i;
...
{
printf("================= JCPRINT:AtomVecAtomic::pack_restart is being called ======\n");
  int m = 1;
  buf[m++] = x[i][0];
  buf[m++] = x[i][1];
  buf[m++] = x[i][2];
...
{
printf("================= JCPRINT:AtomVecAtomic::unpack_restart is being called ======\n");
  int nlocal = atom->nlocal;
  if (nlocal == nmax) {
    grow(0);
...
{
printf("================= JCPRINT:AtomVecAtomic::create_atom is being called ======\n");
  int nlocal = atom->nlocal;
  if (nlocal == nmax) grow(0);
...
{
printf("================= JCPRINT:AtomVecAtomic::data_atom is being called ======\n");
  int nlocal = atom->nlocal;
  if (nlocal == nmax) grow(0);
...
{
printf("================= JCPRINT:AtomVecAtomic::pack_data is being called ======\n");
  int nlocal = atom->nlocal;
...
{
printf("================= JCPRINT:AtomVecAtomic::write_data is being called ======\n");
  for (int i = 0; i < n; i++)
...
{
printf("================= JCPRINT:AtomVecAtomic::memory_usage is being called ======\n");
  bigint bytes = 0;
