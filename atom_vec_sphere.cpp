...
AtomVecSphere::AtomVecSphere(LAMMPS *lmp) : AtomVec(lmp)
{
  ...
  atom->radius_flag = atom->rmass_flag = atom->omega_flag = atom->density_flag =
    atom->torque_flag = 1;
fprintf(screen,"atom_vec_sphere is being used \n");
}
...
{
printf("================= JCPRINT: AtomVecSphere::init is being called ======\n");
  AtomVec::init();
...
{
printf("================= JCPRINT: AtomVecSphere::grow is being called ======\n");
  if (n == 0) nmax += DELTA;
  else nmax = n;
  atom->nmax = nmax;
...
{
printf("================= JCPRINT:AtomVecSphere::grow_reset is being called ======\n");
...
{
printf("================= JCPRINT:AtomVecSphere::copy is being called ======\n");
  tag[j] = tag[i];
  type[j] = type[i];
  mask[j] = mask[i];
  image[j] = image[i];
...
{
printf("================= JCPRINT:AtomVecSphere::pack_comm is being called ======\n");
  int i,j,m;
  double dx,dy,dz;
...
int AtomVecSphere::pack_comm_vel(int n, int *list, double *buf,
                                   int pbc_flag, int *pbc)
{
printf("================= JCPRINT:AtomVecSphere::pack_comm_vel is being called ======\n");
...
{
printf("================= JCPRINT:AtomVecSphere::pack_comm_hybrid is being called ======\n");
  int i,j,m;
...
{
printf("================= JCPRINT:AtomVecSphere::unpack_comm is being called ======\n");
  int i,m,last;
...
{
printf("================= JCPRINT:AtomVecSphere::unpack_comm_vel is being called ======\n");
  int i,m,last;
...
{
printf("================= JCPRINT:AtomVecSphere::unpack_comm_hybrid is being called ======\n");
  int i,m,last;
...
{
printf("================= JCPRINT:AtomVecSphere::pack_reverse is being called ======\n");
  int i,m,last;
...
{
printf("================= JCPRINT:AtomVecSphere::pack_reverse_hybrid is being called ======\n");
  int i,m,last;
...
{
printf("================= JCPRINT:AtomVecSphere::unpack_reverse_hybrid is being called ======\n");
  int i,j,m;
...
int AtomVecSphere::pack_border(int n, int *list, double *buf,
                                 int pbc_flag, int *pbc)
{
printf("================= JCPRINT:AtomVecSphere::pack_border is being called ======\n");
  int i,j,m;
  double dx,dy,dz;
...
int AtomVecSphere::pack_border_vel(int n, int *list, double *buf,
                                     int pbc_flag, int *pbc)
{
printf("================= JCPRINT:AtomVecSphere::pack_border_vel is being called ======\n");
  if(dynamic_cast<DomainWedge*>(domain))
...
{
printf("================= JCPRINT:AtomVecSphere::pack_border_hybrid is being called ======\n");
  int i,j,m;
...
{
printf("================= JCPRINT:AtomVecSphere::unpack_border is being called ======\n");
  int i,m,last;
...
{
printf("================= JCPRINT:AtomVecSphere::unpack_border_vel is being called ======\n");
  int i,m,last;
...
{
printf("================= JCPRINT:AtomVecSphere::unpack_border_hybrid is being called ======\n");
  int i,m,last;
...
{
printf("================= JCPRINT:AtomVecSphere::pack_exchange is being called ======\n");
  int m = 1;
  buf[m++] = x[i][0];
  buf[m++] = x[i][1];
  buf[m++] = x[i][2];
...
{
printf("================= JCPRINT:AtomVecSphere::unpack_exchange is being called ======\n");
...
{
printf("================= JCPRINT:AtomVecSphere::size_restart is being called ======\n");
  int i;
...
{
printf("================= JCPRINT:AtomVecSphere::pack_restart is being called ======\n");
  int m = 1;
  buf[m++] = x[i][0];
  buf[m++] = x[i][1];
  buf[m++] = x[i][2];
...
{
printf("================= JCPRINT:AtomVecSphere::unpack_restart is being called ======\n");
  int nlocal = atom->nlocal;
  if (nlocal == nmax) {
    grow(0);
...
{
printf("================= JCPRINT:AtomVecSphere::create_atom is being called ======\n");
  int nlocal = atom->nlocal;
  if (nlocal == nmax) grow(0);
...
{
printf("================= JCPRINT:AtomVecSphere::data_atom is being called ======\n");
  int nlocal = atom->nlocal;
  if (nlocal == nmax) grow(0);
...
{
printf("================= JCPRINT:AtomVecSphere::data_atom_hybrid is being called ======\n");
...
{
printf("================= JCPRINT:AtomVecSphere::data_vel is being called ======\n");
  v[m][0] = atof(values[0]);
  v[m][1] = atof(values[1]);
  v[m][2] = atof(values[2]);
...
{
printf("================= JCPRINT:AtomVecSphere::data_vel_hybrid is being called ======\n");
...
{
printf("================= JCPRINT:AtomVecSphere::pack_data1 is being called ======\n");
  int nlocal = atom->nlocal;
...
{
printf("================= JCPRINT:AtomVecSphere::pack_data2 is being called ======\n");
  int nlocal = atom->nlocal;
  for (int i = 0; i < nlocal; i++) {
...
{
printf("================= JCPRINT:AtomVecSphere::pack_data_hybrid is being called ======\n");
  buf[0] = 2.0*radius[i];
...
{
printf("================= JCPRINT:AtomVecSphere::write_data is being called ======\n");
  for (int i = 0; i < n; i++)
...
{
printf("================= JCPRINT:AtomVecSphere::write_data_hybrid is being called ======\n");
...
{
printf("================= JCPRINT:AtomVecSphere::pack_vel1 is being called ======\n");
  int nlocal = atom->nlocal;
  for (int i = 0; i < nlocal; i++) {
    buf[i][0] = ubuf(tag[i]).d;
    buf[i][1] = v[i][0];
...
{
printf("================= JCPRINT:AtomVecSphere::pack_vel2 is being called ======\n");
  int nlocal = atom->nlocal;
  for (int i = 0; i < nlocal; i++) {
    buf[i][0] = ubuf(tag[i]+tag_offset).d;
    buf[i][1] = v[i][0];
...
{
printf("================= JCPRINT:AtomVecSphere::pack_vel_hybrid is being called ======\n");
  buf[0] = omega[i][0];
  buf[1] = omega[i][1];
  buf[2] = omega[i][2];
  return 3;
...
{
printf("================= JCPRINT:AtomVecSphere::write_vel is being called ======\n");
  for (int i = 0; i < n; i++)
...
{
printf("================= JCPRINT:AtomVecSphere::write_vel_hybrid is being called ======\n");
...
{
printf("================= JCPRINT:AtomVecSphere::memory_usage is being called ======\n");
  bigint bytes = 0;
