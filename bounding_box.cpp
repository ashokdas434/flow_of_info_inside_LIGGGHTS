...
printf("bounding_box is being used \n");
}
  ...
  {
  printf("================= JCPRINT: BoundingBox::reset is being called ======\n");
    xLo = 0.; xHi = 0.;
    yLo = 0.; yHi = 0.;
    zLo = 0.; zHi = 0.;
    initGiven = false;
  ...
  {
  printf("================= JCPRINT: BoundingBox::extendByDelta is being called ======\n");
    xLo = xLo-delta;
    yLo = yLo-delta;
    zLo = zLo-delta;
    xHi = xHi+delta;
  ...
  {
  printf("================= JCPRINT: BoundingBox::extrude is being called ======\n");
