...
fprintf(screen,"irregular is being used \n");
}
...
{
printf("================= JCPRINT:Irregular::migrate_atoms is being called ======\n"); 
...
{
printf("================= JCPRINT:Irregular::migrate_check is being called ======\n"); 
  // subbox bounds for orthogonal or triclinic box
  // other comm/domain data used by coord2proc()
...
{
printf("================= JCPRINT:Irregular::create_atom is being called ======\n"); 
  int i;
...
{
printf("================= JCPRINT:Irregular::exchange_atom is being called ======\n"); 
...
{
printf("================= JCPRINT:Irregular::destroy_atom is being called ======\n"); 
...
{
printf("================= JCPRINT:Irregular::create_data is being called ======\n"); 
  int i,m;
...
{
printf("================= JCPRINT:Irregular::exchange_data is being called ======\n"); 
  int i,m,n,offset,num_send;
...
{
printf("================= JCPRINT:Irregular::destroy_data is being called ======\n"); 
...
{
printf("================= JCPRINT:Irregular::coord2proc is being called ======\n"); 
  if (uniform) {
    if (triclinic == 0) {
...
{
printf("================= JCPRINT:Irregular::binary is being called ======\n"); 
  int lo = 0;
  int hi = n-1;
...
{
printf("================= JCPRINT:Irregular::grow_send is being called ======\n"); 
...
{
printf("================= JCPRINT:Irregular::grow_recv is being called ======\n"); 
...
{
printf("================= JCPRINT:Irregular::memory_usage is being called ======\n"); 
