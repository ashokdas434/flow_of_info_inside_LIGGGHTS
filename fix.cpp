...
fprintf(screen,"fix is being used \n");
}
...
{
printf("================= JCPRINT:Fix::modify_params is being called ======\n");
...
{
printf("================= JCPRINT:Fix::v_setup is being called ======\n");
  int i,n;
...
{
printf("================= JCPRINT:Fix::v_tally is being called ======\n");
  int m;
...
{
printf("================= JCPRINT:Fix::write_restart is being called ======\n");
    int n = 0;
    if (comm->me == 0)
